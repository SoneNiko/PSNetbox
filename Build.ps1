...
$Manifest = @{
    ...
    Description = 'PSOpenAPITools - the PowerShell module for NetBox REST API'

    ModuleVersion = '0.1.2'

    RootModule = 'PSOpenAPITools.psm1'
    Guid = '{D65D4DA0-ABF5-46CE-88C0-058D8ED48194}' # Has to be static, otherwise each new build will be considered different module
