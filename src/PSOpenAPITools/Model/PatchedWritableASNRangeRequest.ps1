...
PatchedWritableASNRangeRequest<PSCustomObject>
#>

function Initialize-PatchedWritableASNRangeRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableASNRangeRequest' | Write-Debug
...
Convert from JSON to PatchedWritableASNRangeRequest<PSCustomObject>
...
PatchedWritableASNRangeRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableASNRangeRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableASNRangeRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableASNRangeRequest
