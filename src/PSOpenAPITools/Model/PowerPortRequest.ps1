...
PowerPortRequest<PSCustomObject>
#>

function Initialize-PowerPortRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PowerPortRequest' | Write-Debug
...
Convert from JSON to PowerPortRequest<PSCustomObject>
...
PowerPortRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPowerPortRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PowerPortRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PowerPortRequest
