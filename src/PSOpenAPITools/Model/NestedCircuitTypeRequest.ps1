...
NestedCircuitTypeRequest<PSCustomObject>
#>

function Initialize-NestedCircuitTypeRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedCircuitTypeRequest' | Write-Debug
...
Convert from JSON to NestedCircuitTypeRequest<PSCustomObject>
...
NestedCircuitTypeRequest<PSCustomObject>
#>
function ConvertFrom-JsonToNestedCircuitTypeRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedCircuitTypeRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedCircuitTypeRequest
