...
PaginatedClusterList<PSCustomObject>
#>

function Initialize-PaginatedClusterList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedClusterList' | Write-Debug
...
Convert from JSON to PaginatedClusterList<PSCustomObject>
...
PaginatedClusterList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedClusterList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedClusterList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedClusterList
