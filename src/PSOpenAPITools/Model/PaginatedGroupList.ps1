...
PaginatedGroupList<PSCustomObject>
#>

function Initialize-PaginatedGroupList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedGroupList' | Write-Debug
...
Convert from JSON to PaginatedGroupList<PSCustomObject>
...
PaginatedGroupList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedGroupList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedGroupList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedGroupList
