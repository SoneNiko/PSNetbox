...
PatchedWritableTenantGroupRequest<PSCustomObject>
#>

function Initialize-PatchedWritableTenantGroupRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableTenantGroupRequest' | Write-Debug
...
Convert from JSON to PatchedWritableTenantGroupRequest<PSCustomObject>
...
PatchedWritableTenantGroupRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableTenantGroupRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableTenantGroupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableTenantGroupRequest
