...
PatchedWritableVirtualMachineWithConfigContextRequest<PSCustomObject>
#>

function Initialize-PatchedWritableVirtualMachineWithConfigContextRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableVirtualMachineWithConfigContextRequest' | Write-Debug
...
Convert from JSON to PatchedWritableVirtualMachineWithConfigContextRequest<PSCustomObject>
...
PatchedWritableVirtualMachineWithConfigContextRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableVirtualMachineWithConfigContextRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableVirtualMachineWithConfigContextRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableVirtualMachineWithConfigContextRequest
