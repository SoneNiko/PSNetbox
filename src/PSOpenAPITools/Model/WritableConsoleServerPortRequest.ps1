...
WritableConsoleServerPortRequest<PSCustomObject>
#>

function Initialize-WritableConsoleServerPortRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableConsoleServerPortRequest' | Write-Debug
...
Convert from JSON to WritableConsoleServerPortRequest<PSCustomObject>
...
WritableConsoleServerPortRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableConsoleServerPortRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableConsoleServerPortRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableConsoleServerPortRequest
