...
function Initialize-Group {
    ...
    Process {
        ...
        if ($null -eq $UserCount) {
            throw "invalid value for 'UserCount', 'UserCount' cannot be null."
        }
...
function ConvertFrom-JsonToGroup {
    ...
    Process {
        ...
        $AllProperties = ("id", "url", "display", "name", "user_count")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "user_count"))) {
            throw "Error! JSON cannot be serialized due to the required property 'user_count' missing."
        } else {
