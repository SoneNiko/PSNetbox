...
PowerFeed<PSCustomObject>
#>

function Initialize-PowerFeed {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PowerFeed' | Write-Debug
...
Convert from JSON to PowerFeed<PSCustomObject>
...
PowerFeed<PSCustomObject>
#>
function ConvertFrom-JsonToPowerFeed {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PowerFeed' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PowerFeed
        $AllProperties = ("id", "url", "display", "power_panel", "rack", "name", "status", "type", "supply", "phase", "voltage", "amperage", "max_utilization", "mark_connected", "cable", "cable_end", "link_peers", "link_peers_type", "connected_endpoints", "connected_endpoints_type", "connected_endpoints_reachable", "description", "tenant", "comments", "tags", "custom_fields", "created", "last_updated", "_occupied")
