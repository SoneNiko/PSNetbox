...
PatchedWritableInterfaceTemplateRequest<PSCustomObject>
#>

function Initialize-PatchedWritableInterfaceTemplateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableInterfaceTemplateRequest' | Write-Debug
...
Convert from JSON to PatchedWritableInterfaceTemplateRequest<PSCustomObject>
...
PatchedWritableInterfaceTemplateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableInterfaceTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableInterfaceTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableInterfaceTemplateRequest
