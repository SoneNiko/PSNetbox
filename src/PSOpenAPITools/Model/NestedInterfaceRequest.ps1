...
NestedInterfaceRequest<PSCustomObject>
#>

function Initialize-NestedInterfaceRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedInterfaceRequest' | Write-Debug
...
Convert from JSON to NestedInterfaceRequest<PSCustomObject>
...
NestedInterfaceRequest<PSCustomObject>
#>
function ConvertFrom-JsonToNestedInterfaceRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedInterfaceRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedInterfaceRequest
