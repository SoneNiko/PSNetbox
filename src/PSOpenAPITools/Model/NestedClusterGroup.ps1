...
NestedClusterGroup<PSCustomObject>
#>

function Initialize-NestedClusterGroup {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedClusterGroup' | Write-Debug
...
Convert from JSON to NestedClusterGroup<PSCustomObject>
...
NestedClusterGroup<PSCustomObject>
#>
function ConvertFrom-JsonToNestedClusterGroup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedClusterGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedClusterGroup
