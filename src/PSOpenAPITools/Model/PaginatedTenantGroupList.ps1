...
PaginatedTenantGroupList<PSCustomObject>
#>

function Initialize-PaginatedTenantGroupList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedTenantGroupList' | Write-Debug
...
Convert from JSON to PaginatedTenantGroupList<PSCustomObject>
...
PaginatedTenantGroupList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedTenantGroupList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedTenantGroupList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedTenantGroupList
