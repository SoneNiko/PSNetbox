...
ConsolePortTemplateRequest<PSCustomObject>
#>

function Initialize-ConsolePortTemplateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ConsolePortTemplateRequest' | Write-Debug
...
Convert from JSON to ConsolePortTemplateRequest<PSCustomObject>
...
ConsolePortTemplateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToConsolePortTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ConsolePortTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ConsolePortTemplateRequest
