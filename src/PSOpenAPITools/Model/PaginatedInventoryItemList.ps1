...
PaginatedInventoryItemList<PSCustomObject>
#>

function Initialize-PaginatedInventoryItemList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedInventoryItemList' | Write-Debug
...
Convert from JSON to PaginatedInventoryItemList<PSCustomObject>
...
PaginatedInventoryItemList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedInventoryItemList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedInventoryItemList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedInventoryItemList
