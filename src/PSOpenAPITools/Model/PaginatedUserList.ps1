...
PaginatedUserList<PSCustomObject>
#>

function Initialize-PaginatedUserList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedUserList' | Write-Debug
...
Convert from JSON to PaginatedUserList<PSCustomObject>
...
PaginatedUserList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedUserList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedUserList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedUserList
