...
ClusterGroupRequest<PSCustomObject>
#>

function Initialize-ClusterGroupRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClusterGroupRequest' | Write-Debug
...
Convert from JSON to ClusterGroupRequest<PSCustomObject>
...
ClusterGroupRequest<PSCustomObject>
#>
function ConvertFrom-JsonToClusterGroupRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClusterGroupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClusterGroupRequest
