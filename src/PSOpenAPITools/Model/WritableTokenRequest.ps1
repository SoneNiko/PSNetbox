...
WritableTokenRequest<PSCustomObject>
#>

function Initialize-WritableTokenRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableTokenRequest' | Write-Debug
...
Convert from JSON to WritableTokenRequest<PSCustomObject>
...
WritableTokenRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableTokenRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableTokenRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableTokenRequest
