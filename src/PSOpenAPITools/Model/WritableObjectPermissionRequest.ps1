...
WritableObjectPermissionRequest<PSCustomObject>
#>

function Initialize-WritableObjectPermissionRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableObjectPermissionRequest' | Write-Debug
...
Convert from JSON to WritableObjectPermissionRequest<PSCustomObject>
...
WritableObjectPermissionRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableObjectPermissionRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableObjectPermissionRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableObjectPermissionRequest
