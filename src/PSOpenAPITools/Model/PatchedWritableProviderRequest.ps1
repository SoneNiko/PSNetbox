...
PatchedWritableProviderRequest<PSCustomObject>
#>

function Initialize-PatchedWritableProviderRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableProviderRequest' | Write-Debug
...
Convert from JSON to PatchedWritableProviderRequest<PSCustomObject>
...
PatchedWritableProviderRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableProviderRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableProviderRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableProviderRequest
