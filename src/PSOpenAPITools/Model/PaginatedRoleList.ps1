...
PaginatedRoleList<PSCustomObject>
#>

function Initialize-PaginatedRoleList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedRoleList' | Write-Debug
...
Convert from JSON to PaginatedRoleList<PSCustomObject>
...
PaginatedRoleList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedRoleList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedRoleList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedRoleList
