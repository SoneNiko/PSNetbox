...
ASNRange<PSCustomObject>
#>

function Initialize-ASNRange {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ASNRange' | Write-Debug
        ...
        if ($null -eq $AsnCount) {
            throw "invalid value for 'AsnCount', 'AsnCount' cannot be null."
        }
...
Convert from JSON to ASNRange<PSCustomObject>
...
ASNRange<PSCustomObject>
#>
function ConvertFrom-JsonToASNRange {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ASNRange' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ASNRange
        $AllProperties = ("id", "url", "display", "name", "slug", "rir", "start", "end", "tenant", "description", "tags", "custom_fields", "created", "last_updated", "asn_count")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "asn_count"))) {
            throw "Error! JSON cannot be serialized due to the required property 'asn_count' missing."
        } else {
            $AsnCount = $JsonParameters.PSobject.Properties["asn_count"].value
        }
