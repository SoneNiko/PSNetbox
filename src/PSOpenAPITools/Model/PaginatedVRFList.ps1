...
PaginatedVRFList<PSCustomObject>
#>

function Initialize-PaginatedVRFList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedVRFList' | Write-Debug
...
Convert from JSON to PaginatedVRFList<PSCustomObject>
...
PaginatedVRFList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedVRFList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedVRFList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedVRFList
