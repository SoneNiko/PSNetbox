...
WritableSiteGroupRequest<PSCustomObject>
#>

function Initialize-WritableSiteGroupRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableSiteGroupRequest' | Write-Debug
...
Convert from JSON to WritableSiteGroupRequest<PSCustomObject>
...
WritableSiteGroupRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableSiteGroupRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableSiteGroupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableSiteGroupRequest
