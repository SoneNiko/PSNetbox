...
ClusterRequest<PSCustomObject>
#>

function Initialize-ClusterRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClusterRequest' | Write-Debug
...
Convert from JSON to ClusterRequest<PSCustomObject>
...
ClusterRequest<PSCustomObject>
#>
function ConvertFrom-JsonToClusterRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClusterRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClusterRequest
