...
NestedClusterTypeRequest<PSCustomObject>
#>

function Initialize-NestedClusterTypeRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedClusterTypeRequest' | Write-Debug
...
Convert from JSON to NestedClusterTypeRequest<PSCustomObject>
...
NestedClusterTypeRequest<PSCustomObject>
#>
function ConvertFrom-JsonToNestedClusterTypeRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedClusterTypeRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedClusterTypeRequest
