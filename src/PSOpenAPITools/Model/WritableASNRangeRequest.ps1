...
WritableASNRangeRequest<PSCustomObject>
#>

function Initialize-WritableASNRangeRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableASNRangeRequest' | Write-Debug
...
Convert from JSON to WritableASNRangeRequest<PSCustomObject>
...
WritableASNRangeRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableASNRangeRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableASNRangeRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableASNRangeRequest
