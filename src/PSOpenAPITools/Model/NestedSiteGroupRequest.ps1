...
NestedSiteGroupRequest<PSCustomObject>
#>

function Initialize-NestedSiteGroupRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedSiteGroupRequest' | Write-Debug
...
Convert from JSON to NestedSiteGroupRequest<PSCustomObject>
...
NestedSiteGroupRequest<PSCustomObject>
#>
function ConvertFrom-JsonToNestedSiteGroupRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedSiteGroupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedSiteGroupRequest
