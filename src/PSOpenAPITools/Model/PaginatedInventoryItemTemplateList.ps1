...
PaginatedInventoryItemTemplateList<PSCustomObject>
#>

function Initialize-PaginatedInventoryItemTemplateList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedInventoryItemTemplateList' | Write-Debug
...
Convert from JSON to PaginatedInventoryItemTemplateList<PSCustomObject>
...
PaginatedInventoryItemTemplateList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedInventoryItemTemplateList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedInventoryItemTemplateList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedInventoryItemTemplateList
