...
function Initialize-Cluster {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Cluster' | Write-Debug
...
Convert from JSON to Cluster<PSCustomObject>
...
Cluster<PSCustomObject>
#>
function ConvertFrom-JsonToCluster {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Cluster' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Cluster
        $AllProperties = ("id", "url", "display", "name", "type", "group", "status", "tenant", "site", "description", "comments", "tags", "custom_fields", "created", "last_updated", "device_count", "virtualmachine_count")
