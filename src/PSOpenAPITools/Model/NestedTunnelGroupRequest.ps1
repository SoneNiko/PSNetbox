...
NestedTunnelGroupRequest<PSCustomObject>
#>

function Initialize-NestedTunnelGroupRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedTunnelGroupRequest' | Write-Debug
...
Convert from JSON to NestedTunnelGroupRequest<PSCustomObject>
...
NestedTunnelGroupRequest<PSCustomObject>
#>
function ConvertFrom-JsonToNestedTunnelGroupRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedTunnelGroupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedTunnelGroupRequest
