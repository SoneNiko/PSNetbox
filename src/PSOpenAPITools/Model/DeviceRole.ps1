...
DeviceRole<PSCustomObject>
#>

function Initialize-DeviceRole {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DeviceRole' | Write-Debug
...
Convert from JSON to DeviceRole<PSCustomObject>
...
DeviceRole<PSCustomObject>
#>
function ConvertFrom-JsonToDeviceRole {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DeviceRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeviceRole
        $AllProperties = ("id", "url", "display", "name", "slug", "color", "vm_role", "config_template", "description", "tags", "custom_fields", "created", "last_updated", "device_count", "virtualmachine_count")
