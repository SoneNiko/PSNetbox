...
PaginatedManufacturerList<PSCustomObject>
#>

function Initialize-PaginatedManufacturerList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedManufacturerList' | Write-Debug
...
Convert from JSON to PaginatedManufacturerList<PSCustomObject>
...
PaginatedManufacturerList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedManufacturerList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedManufacturerList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedManufacturerList
