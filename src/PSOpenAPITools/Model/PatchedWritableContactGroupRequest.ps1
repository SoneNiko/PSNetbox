...
PatchedWritableContactGroupRequest<PSCustomObject>
#>

function Initialize-PatchedWritableContactGroupRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableContactGroupRequest' | Write-Debug
...
Convert from JSON to PatchedWritableContactGroupRequest<PSCustomObject>
...
PatchedWritableContactGroupRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableContactGroupRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableContactGroupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableContactGroupRequest
