...
NestedPlatformRequest<PSCustomObject>
#>

function Initialize-NestedPlatformRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedPlatformRequest' | Write-Debug
...
Convert from JSON to NestedPlatformRequest<PSCustomObject>
...
NestedPlatformRequest<PSCustomObject>
#>
function ConvertFrom-JsonToNestedPlatformRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedPlatformRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedPlatformRequest
