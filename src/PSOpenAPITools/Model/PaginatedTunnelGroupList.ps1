...
PaginatedTunnelGroupList<PSCustomObject>
#>

function Initialize-PaginatedTunnelGroupList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedTunnelGroupList' | Write-Debug
...
Convert from JSON to PaginatedTunnelGroupList<PSCustomObject>
...
PaginatedTunnelGroupList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedTunnelGroupList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedTunnelGroupList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedTunnelGroupList
