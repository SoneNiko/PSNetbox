...
NestedInventoryItemRole<PSCustomObject>
#>

function Initialize-NestedInventoryItemRole {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedInventoryItemRole' | Write-Debug
...
Convert from JSON to NestedInventoryItemRole<PSCustomObject>
...
NestedInventoryItemRole<PSCustomObject>
#>
function ConvertFrom-JsonToNestedInventoryItemRole {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedInventoryItemRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedInventoryItemRole
