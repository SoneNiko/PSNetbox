...
PatchedWritableVLANRequest<PSCustomObject>
#>

function Initialize-PatchedWritableVLANRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableVLANRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        if ($Vid -and $Vid -gt 4094) {
...
Convert from JSON to PatchedWritableVLANRequest<PSCustomObject>
...
PatchedWritableVLANRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableVLANRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableVLANRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableVLANRequest
