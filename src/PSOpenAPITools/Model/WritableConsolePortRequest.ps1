...
WritableConsolePortRequest<PSCustomObject>
#>

function Initialize-WritableConsolePortRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableConsolePortRequest' | Write-Debug
...
Convert from JSON to WritableConsolePortRequest<PSCustomObject>
...
WritableConsolePortRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableConsolePortRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableConsolePortRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableConsolePortRequest
