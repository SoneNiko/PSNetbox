...
WritableRegionRequest<PSCustomObject>
#>

function Initialize-WritableRegionRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableRegionRequest' | Write-Debug
...
Convert from JSON to WritableRegionRequest<PSCustomObject>
...
WritableRegionRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableRegionRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableRegionRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableRegionRequest
