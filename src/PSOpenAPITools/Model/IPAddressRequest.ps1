...
IPAddressRequest<PSCustomObject>
#>

function Initialize-IPAddressRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IPAddressRequest' | Write-Debug
...
Convert from JSON to IPAddressRequest<PSCustomObject>
...
IPAddressRequest<PSCustomObject>
#>
function ConvertFrom-JsonToIPAddressRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IPAddressRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IPAddressRequest
