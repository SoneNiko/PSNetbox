...
WritableTunnelTerminationRequest<PSCustomObject>
#>

function Initialize-WritableTunnelTerminationRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableTunnelTerminationRequest' | Write-Debug
...
Convert from JSON to WritableTunnelTerminationRequest<PSCustomObject>
...
WritableTunnelTerminationRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableTunnelTerminationRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableTunnelTerminationRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableTunnelTerminationRequest
