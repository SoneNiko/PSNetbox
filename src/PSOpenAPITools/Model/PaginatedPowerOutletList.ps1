...
PaginatedPowerOutletList<PSCustomObject>
#>

function Initialize-PaginatedPowerOutletList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedPowerOutletList' | Write-Debug
...
Convert from JSON to PaginatedPowerOutletList<PSCustomObject>
...
PaginatedPowerOutletList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedPowerOutletList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedPowerOutletList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedPowerOutletList
