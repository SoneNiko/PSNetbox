...
FrontPort<PSCustomObject>
#>

function Initialize-FrontPort {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FrontPort' | Write-Debug
...
Convert from JSON to FrontPort<PSCustomObject>
...
FrontPort<PSCustomObject>
#>
function ConvertFrom-JsonToFrontPort {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FrontPort' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FrontPort
        $AllProperties = ("id", "url", "display", "device", "module", "name", "label", "type", "color", "rear_port", "rear_port_position", "description", "mark_connected", "cable", "cable_end", "link_peers", "link_peers_type", "tags", "custom_fields", "created", "last_updated", "_occupied")
