...
NestedRackRoleRequest<PSCustomObject>
#>

function Initialize-NestedRackRoleRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedRackRoleRequest' | Write-Debug
...
Convert from JSON to NestedRackRoleRequest<PSCustomObject>
...
NestedRackRoleRequest<PSCustomObject>
#>
function ConvertFrom-JsonToNestedRackRoleRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedRackRoleRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedRackRoleRequest
