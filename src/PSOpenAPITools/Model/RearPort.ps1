...
RearPort<PSCustomObject>
#>

function Initialize-RearPort {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RearPort' | Write-Debug
...
Convert from JSON to RearPort<PSCustomObject>
...
RearPort<PSCustomObject>
#>
function ConvertFrom-JsonToRearPort {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RearPort' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RearPort
        $AllProperties = ("id", "url", "display", "device", "module", "name", "label", "type", "color", "positions", "description", "mark_connected", "cable", "cable_end", "link_peers", "link_peers_type", "tags", "custom_fields", "created", "last_updated", "_occupied")
