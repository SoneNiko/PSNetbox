...
PatchedManufacturerRequest<PSCustomObject>
#>

function Initialize-PatchedManufacturerRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedManufacturerRequest' | Write-Debug
...
Convert from JSON to PatchedManufacturerRequest<PSCustomObject>
...
PatchedManufacturerRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedManufacturerRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedManufacturerRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedManufacturerRequest
        $AllProperties = ("name", "slug", "description", "tags", "custom_fields")
