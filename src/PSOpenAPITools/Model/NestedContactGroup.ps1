...
NestedContactGroup<PSCustomObject>
#>

function Initialize-NestedContactGroup {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedContactGroup' | Write-Debug
...
Convert from JSON to NestedContactGroup<PSCustomObject>
...
NestedContactGroup<PSCustomObject>
#>
function ConvertFrom-JsonToNestedContactGroup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedContactGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedContactGroup
