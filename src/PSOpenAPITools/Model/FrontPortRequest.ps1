...
FrontPortRequest<PSCustomObject>
#>

function Initialize-FrontPortRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FrontPortRequest' | Write-Debug
...
Convert from JSON to FrontPortRequest<PSCustomObject>
...
FrontPortRequest<PSCustomObject>
#>
function ConvertFrom-JsonToFrontPortRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FrontPortRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FrontPortRequest
