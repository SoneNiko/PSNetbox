...
TunnelRequest<PSCustomObject>
#>

function Initialize-TunnelRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TunnelRequest' | Write-Debug
...
Convert from JSON to TunnelRequest<PSCustomObject>
...
TunnelRequest<PSCustomObject>
#>
function ConvertFrom-JsonToTunnelRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TunnelRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TunnelRequest
