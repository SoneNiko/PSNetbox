...
PaginatedPowerOutletTemplateList<PSCustomObject>
#>

function Initialize-PaginatedPowerOutletTemplateList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedPowerOutletTemplateList' | Write-Debug
...
Convert from JSON to PaginatedPowerOutletTemplateList<PSCustomObject>
...
PaginatedPowerOutletTemplateList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedPowerOutletTemplateList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedPowerOutletTemplateList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedPowerOutletTemplateList
