...
PaginatedTokenList<PSCustomObject>
#>

function Initialize-PaginatedTokenList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedTokenList' | Write-Debug
...
Convert from JSON to PaginatedTokenList<PSCustomObject>
...
PaginatedTokenList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedTokenList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedTokenList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedTokenList
