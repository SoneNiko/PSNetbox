...
PaginatedServiceList<PSCustomObject>
#>

function Initialize-PaginatedServiceList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedServiceList' | Write-Debug
...
Convert from JSON to PaginatedServiceList<PSCustomObject>
...
PaginatedServiceList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedServiceList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedServiceList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedServiceList
