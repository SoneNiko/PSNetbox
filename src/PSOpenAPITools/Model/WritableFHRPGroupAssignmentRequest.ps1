...
WritableFHRPGroupAssignmentRequest<PSCustomObject>
#>

function Initialize-WritableFHRPGroupAssignmentRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableFHRPGroupAssignmentRequest' | Write-Debug
...
Convert from JSON to WritableFHRPGroupAssignmentRequest<PSCustomObject>
...
WritableFHRPGroupAssignmentRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableFHRPGroupAssignmentRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableFHRPGroupAssignmentRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableFHRPGroupAssignmentRequest
