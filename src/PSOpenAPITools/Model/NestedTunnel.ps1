...
NestedTunnel<PSCustomObject>
#>

function Initialize-NestedTunnel {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedTunnel' | Write-Debug
...
Convert from JSON to NestedTunnel<PSCustomObject>
...
NestedTunnel<PSCustomObject>
#>
function ConvertFrom-JsonToNestedTunnel {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedTunnel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedTunnel
