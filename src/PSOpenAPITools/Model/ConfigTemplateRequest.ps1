...
ConfigTemplateRequest<PSCustomObject>
#>

function Initialize-ConfigTemplateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ConfigTemplateRequest' | Write-Debug
...
Convert from JSON to ConfigTemplateRequest<PSCustomObject>
...
ConfigTemplateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToConfigTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ConfigTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ConfigTemplateRequest
        $AllProperties = ("name", "description", "environment_params", "template_code", "data_source", "tags")
