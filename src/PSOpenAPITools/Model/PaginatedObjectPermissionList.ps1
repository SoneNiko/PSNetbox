...
PaginatedObjectPermissionList<PSCustomObject>
#>

function Initialize-PaginatedObjectPermissionList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedObjectPermissionList' | Write-Debug
...
Convert from JSON to PaginatedObjectPermissionList<PSCustomObject>
...
PaginatedObjectPermissionList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedObjectPermissionList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedObjectPermissionList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedObjectPermissionList
