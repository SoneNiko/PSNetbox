...
TunnelGroupRequest<PSCustomObject>
#>

function Initialize-TunnelGroupRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TunnelGroupRequest' | Write-Debug
...
Convert from JSON to TunnelGroupRequest<PSCustomObject>
...
TunnelGroupRequest<PSCustomObject>
#>
function ConvertFrom-JsonToTunnelGroupRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TunnelGroupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TunnelGroupRequest
