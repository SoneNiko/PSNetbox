...
PatchedWritablePowerFeedRequest<PSCustomObject>
#>

function Initialize-PatchedWritablePowerFeedRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritablePowerFeedRequest' | Write-Debug
...
Convert from JSON to PatchedWritablePowerFeedRequest<PSCustomObject>
...
PatchedWritablePowerFeedRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritablePowerFeedRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritablePowerFeedRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritablePowerFeedRequest
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "power_panel"))) { #optional property not found
            $PowerPanel = $null
        } else {
