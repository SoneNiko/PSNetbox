...
PlatformRequest<PSCustomObject>
#>

function Initialize-PlatformRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PlatformRequest' | Write-Debug
...
Convert from JSON to PlatformRequest<PSCustomObject>
...
PlatformRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPlatformRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PlatformRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PlatformRequest
