...
ContactRequest<PSCustomObject>
#>

function Initialize-ContactRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContactRequest' | Write-Debug
...
Convert from JSON to ContactRequest<PSCustomObject>
...
ContactRequest<PSCustomObject>
#>
function ConvertFrom-JsonToContactRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContactRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ContactRequest
