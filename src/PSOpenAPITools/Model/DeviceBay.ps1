...
DeviceBay<PSCustomObject>
#>

function Initialize-DeviceBay {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DeviceBay' | Write-Debug
...
Convert from JSON to DeviceBay<PSCustomObject>
...
DeviceBay<PSCustomObject>
#>
function ConvertFrom-JsonToDeviceBay {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DeviceBay' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeviceBay
        $AllProperties = ("id", "url", "display", "device", "name", "label", "description", "installed_device", "tags", "custom_fields", "created", "last_updated")
