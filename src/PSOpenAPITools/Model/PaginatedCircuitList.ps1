...
PaginatedCircuitList<PSCustomObject>
#>

function Initialize-PaginatedCircuitList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedCircuitList' | Write-Debug
...
Convert from JSON to PaginatedCircuitList<PSCustomObject>
...
PaginatedCircuitList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedCircuitList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedCircuitList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedCircuitList
