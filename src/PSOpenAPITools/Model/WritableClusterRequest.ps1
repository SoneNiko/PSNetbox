...
WritableClusterRequest<PSCustomObject>
#>

function Initialize-WritableClusterRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableClusterRequest' | Write-Debug
...
Convert from JSON to WritableClusterRequest<PSCustomObject>
...
WritableClusterRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableClusterRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableClusterRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableClusterRequest
