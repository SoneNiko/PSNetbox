...
PaginatedContactRoleList<PSCustomObject>
#>

function Initialize-PaginatedContactRoleList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedContactRoleList' | Write-Debug
...
Convert from JSON to PaginatedContactRoleList<PSCustomObject>
...
PaginatedContactRoleList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedContactRoleList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedContactRoleList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedContactRoleList
