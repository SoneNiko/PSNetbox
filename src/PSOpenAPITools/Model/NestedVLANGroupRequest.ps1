...
NestedVLANGroupRequest<PSCustomObject>
#>

function Initialize-NestedVLANGroupRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedVLANGroupRequest' | Write-Debug
...
Convert from JSON to NestedVLANGroupRequest<PSCustomObject>
...
NestedVLANGroupRequest<PSCustomObject>
#>
function ConvertFrom-JsonToNestedVLANGroupRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedVLANGroupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedVLANGroupRequest
