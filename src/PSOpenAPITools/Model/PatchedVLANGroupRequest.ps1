...
PatchedVLANGroupRequest<PSCustomObject>
#>

function Initialize-PatchedVLANGroupRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedVLANGroupRequest' | Write-Debug
...
Convert from JSON to PatchedVLANGroupRequest<PSCustomObject>
...
PatchedVLANGroupRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedVLANGroupRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedVLANGroupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedVLANGroupRequest
