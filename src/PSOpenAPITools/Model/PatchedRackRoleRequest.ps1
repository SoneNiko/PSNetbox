...
PatchedRackRoleRequest<PSCustomObject>
#>

function Initialize-PatchedRackRoleRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedRackRoleRequest' | Write-Debug
...
Convert from JSON to PatchedRackRoleRequest<PSCustomObject>
...
PatchedRackRoleRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedRackRoleRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedRackRoleRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedRackRoleRequest
