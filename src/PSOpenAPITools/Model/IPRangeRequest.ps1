...
IPRangeRequest<PSCustomObject>
#>

function Initialize-IPRangeRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IPRangeRequest' | Write-Debug
...
Convert from JSON to IPRangeRequest<PSCustomObject>
...
IPRangeRequest<PSCustomObject>
#>
function ConvertFrom-JsonToIPRangeRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IPRangeRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IPRangeRequest
