...
PatchedWritablePowerOutletRequest<PSCustomObject>
#>

function Initialize-PatchedWritablePowerOutletRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritablePowerOutletRequest' | Write-Debug
...
Convert from JSON to PatchedWritablePowerOutletRequest<PSCustomObject>
...
PatchedWritablePowerOutletRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritablePowerOutletRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritablePowerOutletRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritablePowerOutletRequest
