...
WritableInterfaceRequest<PSCustomObject>
#>

function Initialize-WritableInterfaceRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableInterfaceRequest' | Write-Debug
        ...
        if ($null -eq $Vdcs) {
            throw "invalid value for 'Vdcs', 'Vdcs' cannot be null."
        }
...
Convert from JSON to WritableInterfaceRequest<PSCustomObject>
...
WritableInterfaceRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableInterfaceRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableInterfaceRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableInterfaceRequest
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "vdcs"))) {
            throw "Error! JSON cannot be serialized due to the required property 'vdcs' missing."
        } else {
