...
PowerPanel<PSCustomObject>
#>

function Initialize-PowerPanel {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PowerPanel' | Write-Debug
...
Convert from JSON to PowerPanel<PSCustomObject>
...
PowerPanel<PSCustomObject>
#>
function ConvertFrom-JsonToPowerPanel {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PowerPanel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PowerPanel
        $AllProperties = ("id", "url", "display", "site", "location", "name", "description", "comments", "tags", "custom_fields", "powerfeed_count", "created", "last_updated")
