...
PaginatedIPSecProfileList<PSCustomObject>
#>

function Initialize-PaginatedIPSecProfileList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedIPSecProfileList' | Write-Debug
...
Convert from JSON to PaginatedIPSecProfileList<PSCustomObject>
...
PaginatedIPSecProfileList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedIPSecProfileList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedIPSecProfileList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedIPSecProfileList
