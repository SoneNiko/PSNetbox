...
NestedDeviceRoleRequest<PSCustomObject>
#>

function Initialize-NestedDeviceRoleRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedDeviceRoleRequest' | Write-Debug
...
Convert from JSON to NestedDeviceRoleRequest<PSCustomObject>
...
NestedDeviceRoleRequest<PSCustomObject>
#>
function ConvertFrom-JsonToNestedDeviceRoleRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedDeviceRoleRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedDeviceRoleRequest
