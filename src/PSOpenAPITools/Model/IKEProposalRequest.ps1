...
IKEProposalRequest<PSCustomObject>
#>

function Initialize-IKEProposalRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IKEProposalRequest' | Write-Debug
...
Convert from JSON to IKEProposalRequest<PSCustomObject>
...
IKEProposalRequest<PSCustomObject>
#>
function ConvertFrom-JsonToIKEProposalRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IKEProposalRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IKEProposalRequest
