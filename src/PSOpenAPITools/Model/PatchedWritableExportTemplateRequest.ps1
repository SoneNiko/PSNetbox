...
PatchedWritableExportTemplateRequest<PSCustomObject>
#>

function Initialize-PatchedWritableExportTemplateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableExportTemplateRequest' | Write-Debug
...
Convert from JSON to PatchedWritableExportTemplateRequest<PSCustomObject>
...
PatchedWritableExportTemplateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableExportTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableExportTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableExportTemplateRequest
