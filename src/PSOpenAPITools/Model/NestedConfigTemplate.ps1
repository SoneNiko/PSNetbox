...
NestedConfigTemplate<PSCustomObject>
#>

function Initialize-NestedConfigTemplate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedConfigTemplate' | Write-Debug
...
Convert from JSON to NestedConfigTemplate<PSCustomObject>
...
NestedConfigTemplate<PSCustomObject>
#>
function ConvertFrom-JsonToNestedConfigTemplate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedConfigTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedConfigTemplate
