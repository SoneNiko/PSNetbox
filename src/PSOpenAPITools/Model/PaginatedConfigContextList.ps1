...
PaginatedConfigContextList<PSCustomObject>
#>

function Initialize-PaginatedConfigContextList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedConfigContextList' | Write-Debug
...
Convert from JSON to PaginatedConfigContextList<PSCustomObject>
...
PaginatedConfigContextList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedConfigContextList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedConfigContextList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedConfigContextList
