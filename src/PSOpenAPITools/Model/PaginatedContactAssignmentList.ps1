...
PaginatedContactAssignmentList<PSCustomObject>
#>

function Initialize-PaginatedContactAssignmentList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedContactAssignmentList' | Write-Debug
...
Convert from JSON to PaginatedContactAssignmentList<PSCustomObject>
...
PaginatedContactAssignmentList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedContactAssignmentList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedContactAssignmentList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedContactAssignmentList
