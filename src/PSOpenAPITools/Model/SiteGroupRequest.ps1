...
SiteGroupRequest<PSCustomObject>
#>

function Initialize-SiteGroupRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SiteGroupRequest' | Write-Debug
...
Convert from JSON to SiteGroupRequest<PSCustomObject>
...
SiteGroupRequest<PSCustomObject>
#>
function ConvertFrom-JsonToSiteGroupRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SiteGroupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SiteGroupRequest
