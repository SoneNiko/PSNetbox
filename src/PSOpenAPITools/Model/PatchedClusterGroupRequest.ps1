...
PatchedClusterGroupRequest<PSCustomObject>
#>

function Initialize-PatchedClusterGroupRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedClusterGroupRequest' | Write-Debug
...
Convert from JSON to PatchedClusterGroupRequest<PSCustomObject>
...
PatchedClusterGroupRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedClusterGroupRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedClusterGroupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedClusterGroupRequest
