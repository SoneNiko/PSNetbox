...
PatchedWritableSiteGroupRequest<PSCustomObject>
#>

function Initialize-PatchedWritableSiteGroupRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableSiteGroupRequest' | Write-Debug
...
Convert from JSON to PatchedWritableSiteGroupRequest<PSCustomObject>
...
PatchedWritableSiteGroupRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableSiteGroupRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableSiteGroupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableSiteGroupRequest
