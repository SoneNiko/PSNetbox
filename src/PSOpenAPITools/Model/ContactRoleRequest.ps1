...
ContactRoleRequest<PSCustomObject>
#>

function Initialize-ContactRoleRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContactRoleRequest' | Write-Debug
...
Convert from JSON to ContactRoleRequest<PSCustomObject>
...
ContactRoleRequest<PSCustomObject>
#>
function ConvertFrom-JsonToContactRoleRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContactRoleRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ContactRoleRequest
