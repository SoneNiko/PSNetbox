...
WritableVLANRequest<PSCustomObject>
#>

function Initialize-WritableVLANRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableVLANRequest' | Write-Debug
...
Convert from JSON to WritableVLANRequest<PSCustomObject>
...
WritableVLANRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableVLANRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableVLANRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableVLANRequest
