...
WritableEventRuleRequest<PSCustomObject>
#>

function Initialize-WritableEventRuleRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableEventRuleRequest' | Write-Debug
...
Convert from JSON to WritableEventRuleRequest<PSCustomObject>
...
WritableEventRuleRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableEventRuleRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableEventRuleRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableEventRuleRequest
