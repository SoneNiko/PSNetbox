...
NestedPlatform<PSCustomObject>
#>

function Initialize-NestedPlatform {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedPlatform' | Write-Debug
...
Convert from JSON to NestedPlatform<PSCustomObject>
...
NestedPlatform<PSCustomObject>
#>
function ConvertFrom-JsonToNestedPlatform {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedPlatform' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedPlatform
