...
WritableServiceTemplateRequest<PSCustomObject>
#>

function Initialize-WritableServiceTemplateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableServiceTemplateRequest' | Write-Debug
...
Convert from JSON to WritableServiceTemplateRequest<PSCustomObject>
...
WritableServiceTemplateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableServiceTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableServiceTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableServiceTemplateRequest
