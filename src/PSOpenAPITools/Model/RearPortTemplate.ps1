...
RearPortTemplate<PSCustomObject>
#>

function Initialize-RearPortTemplate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RearPortTemplate' | Write-Debug
...
Convert from JSON to RearPortTemplate<PSCustomObject>
...
RearPortTemplate<PSCustomObject>
#>
function ConvertFrom-JsonToRearPortTemplate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RearPortTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RearPortTemplate
        $AllProperties = ("id", "url", "display", "device_type", "module_type", "name", "label", "type", "color", "positions", "description", "created", "last_updated")
