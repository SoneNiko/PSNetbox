...
PatchedWritableVRFRequest<PSCustomObject>
#>

function Initialize-PatchedWritableVRFRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableVRFRequest' | Write-Debug
...
Convert from JSON to PatchedWritableVRFRequest<PSCustomObject>
...
PatchedWritableVRFRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableVRFRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableVRFRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableVRFRequest
        $AllProperties = ("name", "rd", "tenant", "enforce_unique", "description", "comments", "import_targets", "export_targets", "tags", "custom_fields")
