...
WritableCircuitTerminationRequest<PSCustomObject>
#>

function Initialize-WritableCircuitTerminationRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableCircuitTerminationRequest' | Write-Debug
...
Convert from JSON to WritableCircuitTerminationRequest<PSCustomObject>
...
WritableCircuitTerminationRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableCircuitTerminationRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableCircuitTerminationRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableCircuitTerminationRequest
        ...
        If ([string]::IsNullOrEmpty($Json) -or $Json -eq "{}") { # empty json
            throw "Error! Empty JSON cannot be serialized due to the required property 'circuit' missing."
        }
