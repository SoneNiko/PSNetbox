...
WritableIPAddressRequest<PSCustomObject>
#>

function Initialize-WritableIPAddressRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableIPAddressRequest' | Write-Debug
...
Convert from JSON to WritableIPAddressRequest<PSCustomObject>
...
WritableIPAddressRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableIPAddressRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableIPAddressRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableIPAddressRequest
