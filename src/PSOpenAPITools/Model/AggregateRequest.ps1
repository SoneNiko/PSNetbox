...
AggregateRequest<PSCustomObject>
#>

function Initialize-AggregateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AggregateRequest' | Write-Debug
...
Convert from JSON to AggregateRequest<PSCustomObject>
...
AggregateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToAggregateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AggregateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AggregateRequest
