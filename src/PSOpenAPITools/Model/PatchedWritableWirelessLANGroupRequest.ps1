...
PatchedWritableWirelessLANGroupRequest<PSCustomObject>
#>

function Initialize-PatchedWritableWirelessLANGroupRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableWirelessLANGroupRequest' | Write-Debug
...
Convert from JSON to PatchedWritableWirelessLANGroupRequest<PSCustomObject>
...
PatchedWritableWirelessLANGroupRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableWirelessLANGroupRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableWirelessLANGroupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableWirelessLANGroupRequest
        $AllProperties = ("name", "slug", "parent", "description", "tags", "custom_fields")
