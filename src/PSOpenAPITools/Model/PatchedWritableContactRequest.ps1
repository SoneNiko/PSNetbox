...
PatchedWritableContactRequest<PSCustomObject>
#>

function Initialize-PatchedWritableContactRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableContactRequest' | Write-Debug
...
Convert from JSON to PatchedWritableContactRequest<PSCustomObject>
...
PatchedWritableContactRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableContactRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableContactRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableContactRequest
