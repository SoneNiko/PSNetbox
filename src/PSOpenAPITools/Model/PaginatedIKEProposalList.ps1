...
PaginatedIKEProposalList<PSCustomObject>
#>

function Initialize-PaginatedIKEProposalList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedIKEProposalList' | Write-Debug
...
Convert from JSON to PaginatedIKEProposalList<PSCustomObject>
...
PaginatedIKEProposalList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedIKEProposalList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedIKEProposalList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedIKEProposalList
