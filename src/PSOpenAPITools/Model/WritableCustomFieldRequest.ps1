...
WritableCustomFieldRequest<PSCustomObject>
#>

function Initialize-WritableCustomFieldRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableCustomFieldRequest' | Write-Debug
...
Convert from JSON to WritableCustomFieldRequest<PSCustomObject>
...
WritableCustomFieldRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableCustomFieldRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableCustomFieldRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableCustomFieldRequest
