...
NestedVirtualMachine<PSCustomObject>
#>

function Initialize-NestedVirtualMachine {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedVirtualMachine' | Write-Debug
...
Convert from JSON to NestedVirtualMachine<PSCustomObject>
...
NestedVirtualMachine<PSCustomObject>
#>
function ConvertFrom-JsonToNestedVirtualMachine {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedVirtualMachine' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedVirtualMachine
