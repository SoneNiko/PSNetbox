...
PaginatedModuleTypeList<PSCustomObject>
#>

function Initialize-PaginatedModuleTypeList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedModuleTypeList' | Write-Debug
...
Convert from JSON to PaginatedModuleTypeList<PSCustomObject>
...
PaginatedModuleTypeList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedModuleTypeList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedModuleTypeList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedModuleTypeList
