...
PatchedTunnelGroupRequest<PSCustomObject>
#>

function Initialize-PatchedTunnelGroupRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedTunnelGroupRequest' | Write-Debug
...
Convert from JSON to PatchedTunnelGroupRequest<PSCustomObject>
...
PatchedTunnelGroupRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedTunnelGroupRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedTunnelGroupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedTunnelGroupRequest
