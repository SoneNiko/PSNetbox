...
PaginatedRouteTargetList<PSCustomObject>
#>

function Initialize-PaginatedRouteTargetList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedRouteTargetList' | Write-Debug
...
Convert from JSON to PaginatedRouteTargetList<PSCustomObject>
...
PaginatedRouteTargetList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedRouteTargetList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedRouteTargetList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedRouteTargetList
