...
PatchedWritableRegionRequest<PSCustomObject>
#>

function Initialize-PatchedWritableRegionRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableRegionRequest' | Write-Debug
...
Convert from JSON to PatchedWritableRegionRequest<PSCustomObject>
...
PatchedWritableRegionRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableRegionRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableRegionRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableRegionRequest
