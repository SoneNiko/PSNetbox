...
DeviceBayTemplateRequest<PSCustomObject>
#>

function Initialize-DeviceBayTemplateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DeviceBayTemplateRequest' | Write-Debug
...
Convert from JSON to DeviceBayTemplateRequest<PSCustomObject>
...
DeviceBayTemplateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToDeviceBayTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DeviceBayTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeviceBayTemplateRequest
