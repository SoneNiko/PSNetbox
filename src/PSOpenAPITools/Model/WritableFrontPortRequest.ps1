...
WritableFrontPortRequest<PSCustomObject>
#>

function Initialize-WritableFrontPortRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableFrontPortRequest' | Write-Debug
...
Convert from JSON to WritableFrontPortRequest<PSCustomObject>
...
WritableFrontPortRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableFrontPortRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableFrontPortRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableFrontPortRequest
        $AllProperties = ("device", "module", "name", "label", "type", "color", "rear_port", "rear_port_position", "description", "mark_connected", "tags", "custom_fields")
