...
PaginatedSiteList<PSCustomObject>
#>

function Initialize-PaginatedSiteList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedSiteList' | Write-Debug
...
Convert from JSON to PaginatedSiteList<PSCustomObject>
...
PaginatedSiteList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedSiteList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedSiteList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedSiteList
