...
NestedCluster<PSCustomObject>
#>

function Initialize-NestedCluster {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedCluster' | Write-Debug
...
Convert from JSON to NestedCluster<PSCustomObject>
...
NestedCluster<PSCustomObject>
#>
function ConvertFrom-JsonToNestedCluster {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedCluster' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedCluster
