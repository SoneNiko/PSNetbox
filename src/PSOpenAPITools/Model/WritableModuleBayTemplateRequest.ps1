...
WritableModuleBayTemplateRequest<PSCustomObject>
#>

function Initialize-WritableModuleBayTemplateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableModuleBayTemplateRequest' | Write-Debug
...
Convert from JSON to WritableModuleBayTemplateRequest<PSCustomObject>
...
WritableModuleBayTemplateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableModuleBayTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableModuleBayTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableModuleBayTemplateRequest
