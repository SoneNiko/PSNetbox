...
NestedSite<PSCustomObject>
#>

function Initialize-NestedSite {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedSite' | Write-Debug
...
Convert from JSON to NestedSite<PSCustomObject>
...
NestedSite<PSCustomObject>
#>
function ConvertFrom-JsonToNestedSite {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedSite' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedSite
