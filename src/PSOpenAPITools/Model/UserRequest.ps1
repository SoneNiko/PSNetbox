...
UserRequest<PSCustomObject>
#>

function Initialize-UserRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UserRequest' | Write-Debug
...
Convert from JSON to UserRequest<PSCustomObject>
...
UserRequest<PSCustomObject>
#>
function ConvertFrom-JsonToUserRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UserRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UserRequest
