...
RackRoleRequest<PSCustomObject>
#>

function Initialize-RackRoleRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RackRoleRequest' | Write-Debug
...
Convert from JSON to RackRoleRequest<PSCustomObject>
...
RackRoleRequest<PSCustomObject>
#>
function ConvertFrom-JsonToRackRoleRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RackRoleRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RackRoleRequest
