...
ContactGroupRequest<PSCustomObject>
#>

function Initialize-ContactGroupRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContactGroupRequest' | Write-Debug
...
Convert from JSON to ContactGroupRequest<PSCustomObject>
...
ContactGroupRequest<PSCustomObject>
#>
function ConvertFrom-JsonToContactGroupRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContactGroupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ContactGroupRequest
