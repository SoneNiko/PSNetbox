...
NestedIPSecPolicy<PSCustomObject>
#>

function Initialize-NestedIPSecPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedIPSecPolicy' | Write-Debug
...
Convert from JSON to NestedIPSecPolicy<PSCustomObject>
...
NestedIPSecPolicy<PSCustomObject>
#>
function ConvertFrom-JsonToNestedIPSecPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedIPSecPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedIPSecPolicy
