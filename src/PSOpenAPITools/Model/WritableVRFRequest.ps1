...
WritableVRFRequest<PSCustomObject>
#>

function Initialize-WritableVRFRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableVRFRequest' | Write-Debug
...
Convert from JSON to WritableVRFRequest<PSCustomObject>
...
WritableVRFRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableVRFRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableVRFRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableVRFRequest
