...
PowerFeedRequest<PSCustomObject>
#>

function Initialize-PowerFeedRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PowerFeedRequest' | Write-Debug
...
Convert from JSON to PowerFeedRequest<PSCustomObject>
...
PowerFeedRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPowerFeedRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PowerFeedRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PowerFeedRequest
