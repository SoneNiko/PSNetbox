...
PaginatedDeviceBayList<PSCustomObject>
#>

function Initialize-PaginatedDeviceBayList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedDeviceBayList' | Write-Debug
...
Convert from JSON to PaginatedDeviceBayList<PSCustomObject>
...
PaginatedDeviceBayList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedDeviceBayList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedDeviceBayList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedDeviceBayList
