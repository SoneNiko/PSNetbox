...
NestedTag<PSCustomObject>
#>

function Initialize-NestedTag {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedTag' | Write-Debug
...
Convert from JSON to NestedTag<PSCustomObject>
...
NestedTag<PSCustomObject>
#>
function ConvertFrom-JsonToNestedTag {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedTag' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedTag
        $AllProperties = ("id", "url", "display", "name", "slug", "color")
