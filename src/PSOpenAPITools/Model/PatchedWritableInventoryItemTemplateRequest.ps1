...
PatchedWritableInventoryItemTemplateRequest<PSCustomObject>
#>

function Initialize-PatchedWritableInventoryItemTemplateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableInventoryItemTemplateRequest' | Write-Debug
...
Convert from JSON to PatchedWritableInventoryItemTemplateRequest<PSCustomObject>
...
PatchedWritableInventoryItemTemplateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableInventoryItemTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableInventoryItemTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableInventoryItemTemplateRequest
