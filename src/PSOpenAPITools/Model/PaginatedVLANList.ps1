...
PaginatedVLANList<PSCustomObject>
#>

function Initialize-PaginatedVLANList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedVLANList' | Write-Debug
...
Convert from JSON to PaginatedVLANList<PSCustomObject>
...
PaginatedVLANList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedVLANList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedVLANList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedVLANList
