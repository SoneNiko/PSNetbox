...
PaginatedIPRangeList<PSCustomObject>
#>

function Initialize-PaginatedIPRangeList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedIPRangeList' | Write-Debug
...
Convert from JSON to PaginatedIPRangeList<PSCustomObject>
...
PaginatedIPRangeList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedIPRangeList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedIPRangeList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedIPRangeList
