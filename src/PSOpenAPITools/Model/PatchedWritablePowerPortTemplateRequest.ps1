...
PatchedWritablePowerPortTemplateRequest<PSCustomObject>
#>

function Initialize-PatchedWritablePowerPortTemplateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritablePowerPortTemplateRequest' | Write-Debug
...
Convert from JSON to PatchedWritablePowerPortTemplateRequest<PSCustomObject>
...
PatchedWritablePowerPortTemplateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritablePowerPortTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritablePowerPortTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritablePowerPortTemplateRequest
        $AllProperties = ("device_type", "module_type", "name", "label", "type", "maximum_draw", "allocated_draw", "description")
