...
NestedTunnelGroup<PSCustomObject>
#>

function Initialize-NestedTunnelGroup {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedTunnelGroup' | Write-Debug
...
Convert from JSON to NestedTunnelGroup<PSCustomObject>
...
NestedTunnelGroup<PSCustomObject>
#>
function ConvertFrom-JsonToNestedTunnelGroup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedTunnelGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedTunnelGroup
