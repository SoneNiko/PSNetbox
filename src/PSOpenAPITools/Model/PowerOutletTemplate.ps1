...
PowerOutletTemplate<PSCustomObject>
#>

function Initialize-PowerOutletTemplate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PowerOutletTemplate' | Write-Debug
...
Convert from JSON to PowerOutletTemplate<PSCustomObject>
...
PowerOutletTemplate<PSCustomObject>
#>
function ConvertFrom-JsonToPowerOutletTemplate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PowerOutletTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PowerOutletTemplate
        $AllProperties = ("id", "url", "display", "device_type", "module_type", "name", "label", "type", "power_port", "feed_leg", "description", "created", "last_updated")
