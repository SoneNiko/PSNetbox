...
NestedContactGroupRequest<PSCustomObject>
#>

function Initialize-NestedContactGroupRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedContactGroupRequest' | Write-Debug
...
Convert from JSON to NestedContactGroupRequest<PSCustomObject>
...
NestedContactGroupRequest<PSCustomObject>
#>
function ConvertFrom-JsonToNestedContactGroupRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedContactGroupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedContactGroupRequest
