...
PaginatedAggregateList<PSCustomObject>
#>

function Initialize-PaginatedAggregateList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedAggregateList' | Write-Debug
...
Convert from JSON to PaginatedAggregateList<PSCustomObject>
...
PaginatedAggregateList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedAggregateList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedAggregateList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedAggregateList
