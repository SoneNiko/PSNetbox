...
NestedProviderNetwork<PSCustomObject>
#>

function Initialize-NestedProviderNetwork {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedProviderNetwork' | Write-Debug
...
Convert from JSON to NestedProviderNetwork<PSCustomObject>
...
NestedProviderNetwork<PSCustomObject>
#>
function ConvertFrom-JsonToNestedProviderNetwork {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedProviderNetwork' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedProviderNetwork
