...
L2VPNRequest<PSCustomObject>
#>

function Initialize-L2VPNRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => L2VPNRequest' | Write-Debug
...
Convert from JSON to L2VPNRequest<PSCustomObject>
...
L2VPNRequest<PSCustomObject>
#>
function ConvertFrom-JsonToL2VPNRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => L2VPNRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in L2VPNRequest
