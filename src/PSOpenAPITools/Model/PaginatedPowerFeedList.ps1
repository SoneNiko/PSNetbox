...
PaginatedPowerFeedList<PSCustomObject>
#>

function Initialize-PaginatedPowerFeedList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedPowerFeedList' | Write-Debug
...
Convert from JSON to PaginatedPowerFeedList<PSCustomObject>
...
PaginatedPowerFeedList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedPowerFeedList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedPowerFeedList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedPowerFeedList
