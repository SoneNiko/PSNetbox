...
NestedRIR<PSCustomObject>
#>

function Initialize-NestedRIR {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedRIR' | Write-Debug
...
Convert from JSON to NestedRIR<PSCustomObject>
...
NestedRIR<PSCustomObject>
#>
function ConvertFrom-JsonToNestedRIR {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedRIR' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedRIR
