...
NestedTenant<PSCustomObject>
#>

function Initialize-NestedTenant {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedTenant' | Write-Debug
...
Convert from JSON to NestedTenant<PSCustomObject>
...
NestedTenant<PSCustomObject>
#>
function ConvertFrom-JsonToNestedTenant {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedTenant' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedTenant
