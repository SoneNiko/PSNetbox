...
JournalEntryRequest<PSCustomObject>
#>

function Initialize-JournalEntryRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => JournalEntryRequest' | Write-Debug
...
Convert from JSON to JournalEntryRequest<PSCustomObject>
...
JournalEntryRequest<PSCustomObject>
#>
function ConvertFrom-JsonToJournalEntryRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => JournalEntryRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JournalEntryRequest
