...
WritablePowerOutletRequest<PSCustomObject>
#>

function Initialize-WritablePowerOutletRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritablePowerOutletRequest' | Write-Debug
...
Convert from JSON to WritablePowerOutletRequest<PSCustomObject>
...
WritablePowerOutletRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritablePowerOutletRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritablePowerOutletRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritablePowerOutletRequest
