...
DeviceBayRequest<PSCustomObject>
#>

function Initialize-DeviceBayRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DeviceBayRequest' | Write-Debug
...
Convert from JSON to DeviceBayRequest<PSCustomObject>
...
DeviceBayRequest<PSCustomObject>
#>
function ConvertFrom-JsonToDeviceBayRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DeviceBayRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeviceBayRequest
