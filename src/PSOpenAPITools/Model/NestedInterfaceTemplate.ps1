...
NestedInterfaceTemplate<PSCustomObject>
#>

function Initialize-NestedInterfaceTemplate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedInterfaceTemplate' | Write-Debug
...
Convert from JSON to NestedInterfaceTemplate<PSCustomObject>
...
NestedInterfaceTemplate<PSCustomObject>
#>
function ConvertFrom-JsonToNestedInterfaceTemplate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedInterfaceTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedInterfaceTemplate
        $AllProperties = ("id", "url", "display", "name")
