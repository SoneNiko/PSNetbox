...
CircuitTerminationRequest<PSCustomObject>
#>

function Initialize-CircuitTerminationRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CircuitTerminationRequest' | Write-Debug
...
Convert from JSON to CircuitTerminationRequest<PSCustomObject>
...
CircuitTerminationRequest<PSCustomObject>
#>
function ConvertFrom-JsonToCircuitTerminationRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CircuitTerminationRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CircuitTerminationRequest
