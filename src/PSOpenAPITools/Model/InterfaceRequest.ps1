...
InterfaceRequest<PSCustomObject>
#>

function Initialize-InterfaceRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InterfaceRequest' | Write-Debug
...
Convert from JSON to InterfaceRequest<PSCustomObject>
...
InterfaceRequest<PSCustomObject>
#>
function ConvertFrom-JsonToInterfaceRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InterfaceRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InterfaceRequest
