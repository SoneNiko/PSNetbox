...
NestedTagRequest<PSCustomObject>
#>

function Initialize-NestedTagRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedTagRequest' | Write-Debug
...
Convert from JSON to NestedTagRequest<PSCustomObject>
...
NestedTagRequest<PSCustomObject>
#>
function ConvertFrom-JsonToNestedTagRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedTagRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedTagRequest
        $AllProperties = ("name", "slug", "color")
