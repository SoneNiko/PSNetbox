...
PaginatedIPSecPolicyList<PSCustomObject>
#>

function Initialize-PaginatedIPSecPolicyList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedIPSecPolicyList' | Write-Debug
...
Convert from JSON to PaginatedIPSecPolicyList<PSCustomObject>
...
PaginatedIPSecPolicyList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedIPSecPolicyList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedIPSecPolicyList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedIPSecPolicyList
