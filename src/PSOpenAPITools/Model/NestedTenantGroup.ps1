...
NestedTenantGroup<PSCustomObject>
#>

function Initialize-NestedTenantGroup {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedTenantGroup' | Write-Debug
...
Convert from JSON to NestedTenantGroup<PSCustomObject>
...
NestedTenantGroup<PSCustomObject>
#>
function ConvertFrom-JsonToNestedTenantGroup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedTenantGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedTenantGroup
