...
function Initialize-ModuleType {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModuleType' | Write-Debug
...
Convert from JSON to ModuleType<PSCustomObject>
...
ModuleType<PSCustomObject>
#>
function ConvertFrom-JsonToModuleType {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModuleType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ModuleType
        $AllProperties = ("id", "url", "display", "manufacturer", "model", "part_number", "weight", "weight_unit", "description", "comments", "tags", "custom_fields", "created", "last_updated")
