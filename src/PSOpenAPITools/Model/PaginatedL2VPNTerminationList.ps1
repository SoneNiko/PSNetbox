...
PaginatedL2VPNTerminationList<PSCustomObject>
#>

function Initialize-PaginatedL2VPNTerminationList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedL2VPNTerminationList' | Write-Debug
...
Convert from JSON to PaginatedL2VPNTerminationList<PSCustomObject>
...
PaginatedL2VPNTerminationList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedL2VPNTerminationList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedL2VPNTerminationList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedL2VPNTerminationList
