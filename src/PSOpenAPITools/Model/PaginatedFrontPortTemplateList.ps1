...
PaginatedFrontPortTemplateList<PSCustomObject>
#>

function Initialize-PaginatedFrontPortTemplateList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedFrontPortTemplateList' | Write-Debug
...
Convert from JSON to PaginatedFrontPortTemplateList<PSCustomObject>
...
PaginatedFrontPortTemplateList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedFrontPortTemplateList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedFrontPortTemplateList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedFrontPortTemplateList
