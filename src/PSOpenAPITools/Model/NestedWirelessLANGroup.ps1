...
NestedWirelessLANGroup<PSCustomObject>
#>

function Initialize-NestedWirelessLANGroup {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedWirelessLANGroup' | Write-Debug
...
Convert from JSON to NestedWirelessLANGroup<PSCustomObject>
...
NestedWirelessLANGroup<PSCustomObject>
#>
function ConvertFrom-JsonToNestedWirelessLANGroup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedWirelessLANGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedWirelessLANGroup
        $AllProperties = ("id", "url", "display", "name", "slug", "_depth")
