...
WirelessLANGroupRequest<PSCustomObject>
#>

function Initialize-WirelessLANGroupRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WirelessLANGroupRequest' | Write-Debug
...
Convert from JSON to WirelessLANGroupRequest<PSCustomObject>
...
WirelessLANGroupRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWirelessLANGroupRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WirelessLANGroupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WirelessLANGroupRequest
