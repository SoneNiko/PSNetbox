...
NestedRegionRequest<PSCustomObject>
#>

function Initialize-NestedRegionRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedRegionRequest' | Write-Debug
...
Convert from JSON to NestedRegionRequest<PSCustomObject>
...
NestedRegionRequest<PSCustomObject>
#>
function ConvertFrom-JsonToNestedRegionRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedRegionRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedRegionRequest
