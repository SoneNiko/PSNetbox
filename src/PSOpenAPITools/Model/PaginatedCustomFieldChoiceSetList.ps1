...
PaginatedCustomFieldChoiceSetList<PSCustomObject>
#>

function Initialize-PaginatedCustomFieldChoiceSetList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedCustomFieldChoiceSetList' | Write-Debug
...
Convert from JSON to PaginatedCustomFieldChoiceSetList<PSCustomObject>
...
PaginatedCustomFieldChoiceSetList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedCustomFieldChoiceSetList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedCustomFieldChoiceSetList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedCustomFieldChoiceSetList
