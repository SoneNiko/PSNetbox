...
ConsoleServerPortTemplateRequest<PSCustomObject>
#>

function Initialize-ConsoleServerPortTemplateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ConsoleServerPortTemplateRequest' | Write-Debug
...
Convert from JSON to ConsoleServerPortTemplateRequest<PSCustomObject>
...
ConsoleServerPortTemplateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToConsoleServerPortTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ConsoleServerPortTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ConsoleServerPortTemplateRequest
