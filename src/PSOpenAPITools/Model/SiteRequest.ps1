...
SiteRequest<PSCustomObject>
#>

function Initialize-SiteRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SiteRequest' | Write-Debug
...
Convert from JSON to SiteRequest<PSCustomObject>
...
SiteRequest<PSCustomObject>
#>
function ConvertFrom-JsonToSiteRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SiteRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SiteRequest
