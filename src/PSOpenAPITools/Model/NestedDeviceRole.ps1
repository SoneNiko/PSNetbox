...
NestedDeviceRole<PSCustomObject>
#>

function Initialize-NestedDeviceRole {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedDeviceRole' | Write-Debug
...
Convert from JSON to NestedDeviceRole<PSCustomObject>
...
NestedDeviceRole<PSCustomObject>
#>
function ConvertFrom-JsonToNestedDeviceRole {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedDeviceRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedDeviceRole
