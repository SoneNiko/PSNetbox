...
NestedRole<PSCustomObject>
#>

function Initialize-NestedRole {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedRole' | Write-Debug
...
Convert from JSON to NestedRole<PSCustomObject>
...
NestedRole<PSCustomObject>
#>
function ConvertFrom-JsonToNestedRole {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedRole
