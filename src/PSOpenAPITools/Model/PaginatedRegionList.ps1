...
PaginatedRegionList<PSCustomObject>
#>

function Initialize-PaginatedRegionList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedRegionList' | Write-Debug
...
Convert from JSON to PaginatedRegionList<PSCustomObject>
...
PaginatedRegionList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedRegionList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedRegionList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedRegionList
