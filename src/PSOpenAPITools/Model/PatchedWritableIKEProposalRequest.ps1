...
PatchedWritableIKEProposalRequest<PSCustomObject>
#>

function Initialize-PatchedWritableIKEProposalRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableIKEProposalRequest' | Write-Debug
...
Convert from JSON to PatchedWritableIKEProposalRequest<PSCustomObject>
...
PatchedWritableIKEProposalRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableIKEProposalRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableIKEProposalRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableIKEProposalRequest
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "authentication_method"))) { #optional property not found
