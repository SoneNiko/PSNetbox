...
NestedVirtualChassis<PSCustomObject>
#>

function Initialize-NestedVirtualChassis {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedVirtualChassis' | Write-Debug
...
Convert from JSON to NestedVirtualChassis<PSCustomObject>
...
NestedVirtualChassis<PSCustomObject>
#>
function ConvertFrom-JsonToNestedVirtualChassis {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedVirtualChassis' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedVirtualChassis
        $AllProperties = ("id", "url", "display", "name", "master")
