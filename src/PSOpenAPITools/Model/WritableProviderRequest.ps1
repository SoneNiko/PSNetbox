...
WritableProviderRequest<PSCustomObject>
#>

function Initialize-WritableProviderRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableProviderRequest' | Write-Debug
...
Convert from JSON to WritableProviderRequest<PSCustomObject>
...
WritableProviderRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableProviderRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableProviderRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableProviderRequest
