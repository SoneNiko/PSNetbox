...
WritableSiteRequest<PSCustomObject>
#>

function Initialize-WritableSiteRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableSiteRequest' | Write-Debug
...
Convert from JSON to WritableSiteRequest<PSCustomObject>
...
WritableSiteRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableSiteRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableSiteRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableSiteRequest
