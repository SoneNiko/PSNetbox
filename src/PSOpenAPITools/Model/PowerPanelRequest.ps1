...
PowerPanelRequest<PSCustomObject>
#>

function Initialize-PowerPanelRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PowerPanelRequest' | Write-Debug
...
Convert from JSON to PowerPanelRequest<PSCustomObject>
...
PowerPanelRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPowerPanelRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PowerPanelRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PowerPanelRequest
