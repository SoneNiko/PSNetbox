...
PaginatedProviderNetworkList<PSCustomObject>
#>

function Initialize-PaginatedProviderNetworkList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedProviderNetworkList' | Write-Debug
...
Convert from JSON to PaginatedProviderNetworkList<PSCustomObject>
...
PaginatedProviderNetworkList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedProviderNetworkList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedProviderNetworkList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedProviderNetworkList
