...
ModuleBayTemplateRequest<PSCustomObject>
#>

function Initialize-ModuleBayTemplateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModuleBayTemplateRequest' | Write-Debug
...
Convert from JSON to ModuleBayTemplateRequest<PSCustomObject>
...
ModuleBayTemplateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToModuleBayTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModuleBayTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ModuleBayTemplateRequest
