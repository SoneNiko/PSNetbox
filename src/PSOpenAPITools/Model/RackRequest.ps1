...
RackRequest<PSCustomObject>
#>

function Initialize-RackRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RackRequest' | Write-Debug
...
Convert from JSON to RackRequest<PSCustomObject>
...
RackRequest<PSCustomObject>
#>
function ConvertFrom-JsonToRackRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RackRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RackRequest
