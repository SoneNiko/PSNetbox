...
FrontPortRearPort<PSCustomObject>
#>

function Initialize-FrontPortRearPort {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FrontPortRearPort' | Write-Debug
...
Convert from JSON to FrontPortRearPort<PSCustomObject>
...
FrontPortRearPort<PSCustomObject>
#>
function ConvertFrom-JsonToFrontPortRearPort {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FrontPortRearPort' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FrontPortRearPort
        $AllProperties = ("id", "url", "display", "name", "label", "description")
