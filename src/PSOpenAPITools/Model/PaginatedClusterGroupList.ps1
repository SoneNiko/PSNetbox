...
PaginatedClusterGroupList<PSCustomObject>
#>

function Initialize-PaginatedClusterGroupList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedClusterGroupList' | Write-Debug
...
Convert from JSON to PaginatedClusterGroupList<PSCustomObject>
...
PaginatedClusterGroupList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedClusterGroupList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedClusterGroupList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedClusterGroupList
