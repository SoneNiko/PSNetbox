...
IKEPolicy<PSCustomObject>
#>

function Initialize-IKEPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IKEPolicy' | Write-Debug
...
Convert from JSON to IKEPolicy<PSCustomObject>
...
IKEPolicy<PSCustomObject>
#>
function ConvertFrom-JsonToIKEPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IKEPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IKEPolicy
        $AllProperties = ("id", "url", "display", "name", "description", "version", "mode", "proposals", "preshared_key", "comments", "tags", "custom_fields", "created", "last_updated")
