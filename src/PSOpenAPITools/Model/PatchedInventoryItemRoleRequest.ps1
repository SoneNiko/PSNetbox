...
PatchedInventoryItemRoleRequest<PSCustomObject>
#>

function Initialize-PatchedInventoryItemRoleRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedInventoryItemRoleRequest' | Write-Debug
...
Convert from JSON to PatchedInventoryItemRoleRequest<PSCustomObject>
...
PatchedInventoryItemRoleRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedInventoryItemRoleRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedInventoryItemRoleRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedInventoryItemRoleRequest
        $AllProperties = ("name", "slug", "color", "description", "tags", "custom_fields")
