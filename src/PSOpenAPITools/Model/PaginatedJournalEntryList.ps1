...
PaginatedJournalEntryList<PSCustomObject>
#>

function Initialize-PaginatedJournalEntryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedJournalEntryList' | Write-Debug
...
Convert from JSON to PaginatedJournalEntryList<PSCustomObject>
...
PaginatedJournalEntryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedJournalEntryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedJournalEntryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedJournalEntryList
