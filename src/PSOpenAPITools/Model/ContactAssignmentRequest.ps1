...
ContactAssignmentRequest<PSCustomObject>
#>

function Initialize-ContactAssignmentRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContactAssignmentRequest' | Write-Debug
...
Convert from JSON to ContactAssignmentRequest<PSCustomObject>
...
ContactAssignmentRequest<PSCustomObject>
#>
function ConvertFrom-JsonToContactAssignmentRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContactAssignmentRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ContactAssignmentRequest
