...
WritableRearPortRequest<PSCustomObject>
#>

function Initialize-WritableRearPortRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableRearPortRequest' | Write-Debug
...
Convert from JSON to WritableRearPortRequest<PSCustomObject>
...
WritableRearPortRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableRearPortRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableRearPortRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableRearPortRequest
