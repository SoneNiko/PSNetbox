...
ConsolePortTemplate<PSCustomObject>
#>

function Initialize-ConsolePortTemplate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ConsolePortTemplate' | Write-Debug
...
Convert from JSON to ConsolePortTemplate<PSCustomObject>
...
ConsolePortTemplate<PSCustomObject>
#>
function ConvertFrom-JsonToConsolePortTemplate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ConsolePortTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ConsolePortTemplate
