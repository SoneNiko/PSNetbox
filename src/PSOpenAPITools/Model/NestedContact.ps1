...
NestedContact<PSCustomObject>
#>

function Initialize-NestedContact {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedContact' | Write-Debug
...
Convert from JSON to NestedContact<PSCustomObject>
...
NestedContact<PSCustomObject>
#>
function ConvertFrom-JsonToNestedContact {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedContact' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedContact
