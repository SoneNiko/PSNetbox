...
PaginatedPowerPortList<PSCustomObject>
#>

function Initialize-PaginatedPowerPortList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedPowerPortList' | Write-Debug
...
Convert from JSON to PaginatedPowerPortList<PSCustomObject>
...
PaginatedPowerPortList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedPowerPortList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedPowerPortList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedPowerPortList
