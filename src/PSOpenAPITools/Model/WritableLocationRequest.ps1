...
WritableLocationRequest<PSCustomObject>
#>

function Initialize-WritableLocationRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableLocationRequest' | Write-Debug
...
Convert from JSON to WritableLocationRequest<PSCustomObject>
...
WritableLocationRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableLocationRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableLocationRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableLocationRequest
