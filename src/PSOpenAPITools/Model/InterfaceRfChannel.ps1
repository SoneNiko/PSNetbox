...
InterfaceRfChannel<PSCustomObject>
#>

function Initialize-InterfaceRfChannel {
    [CmdletBinding()]
    Param (
...
Convert from JSON to InterfaceRfChannel<PSCustomObject>
...
InterfaceRfChannel<PSCustomObject>
#>
function ConvertFrom-JsonToInterfaceRfChannel {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InterfaceRfChannel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InterfaceRfChannel
