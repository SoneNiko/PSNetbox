...
PaginatedWirelessLANGroupList<PSCustomObject>
#>

function Initialize-PaginatedWirelessLANGroupList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedWirelessLANGroupList' | Write-Debug
...
Convert from JSON to PaginatedWirelessLANGroupList<PSCustomObject>
...
PaginatedWirelessLANGroupList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedWirelessLANGroupList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedWirelessLANGroupList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedWirelessLANGroupList
