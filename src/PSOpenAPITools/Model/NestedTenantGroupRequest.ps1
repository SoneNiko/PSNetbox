...
NestedTenantGroupRequest<PSCustomObject>
#>

function Initialize-NestedTenantGroupRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedTenantGroupRequest' | Write-Debug
...
Convert from JSON to NestedTenantGroupRequest<PSCustomObject>
...
NestedTenantGroupRequest<PSCustomObject>
#>
function ConvertFrom-JsonToNestedTenantGroupRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedTenantGroupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedTenantGroupRequest
