...
NestedModuleBay<PSCustomObject>
#>

function Initialize-NestedModuleBay {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedModuleBay' | Write-Debug
...
Convert from JSON to NestedModuleBay<PSCustomObject>
...
NestedModuleBay<PSCustomObject>
#>
function ConvertFrom-JsonToNestedModuleBay {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedModuleBay' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedModuleBay
        $AllProperties = ("id", "url", "display", "installed_module", "name")
