...
ConsolePortRequest<PSCustomObject>
#>

function Initialize-ConsolePortRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ConsolePortRequest' | Write-Debug
...
Convert from JSON to ConsolePortRequest<PSCustomObject>
...
ConsolePortRequest<PSCustomObject>
#>
function ConvertFrom-JsonToConsolePortRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ConsolePortRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ConsolePortRequest
