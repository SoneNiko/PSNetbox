...
NestedIPSecProfile<PSCustomObject>
#>

function Initialize-NestedIPSecProfile {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedIPSecProfile' | Write-Debug
...
Convert from JSON to NestedIPSecProfile<PSCustomObject>
...
NestedIPSecProfile<PSCustomObject>
#>
function ConvertFrom-JsonToNestedIPSecProfile {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedIPSecProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedIPSecProfile
