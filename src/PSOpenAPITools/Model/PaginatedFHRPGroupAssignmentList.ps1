...
PaginatedFHRPGroupAssignmentList<PSCustomObject>
#>

function Initialize-PaginatedFHRPGroupAssignmentList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedFHRPGroupAssignmentList' | Write-Debug
...
Convert from JSON to PaginatedFHRPGroupAssignmentList<PSCustomObject>
...
PaginatedFHRPGroupAssignmentList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedFHRPGroupAssignmentList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedFHRPGroupAssignmentList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedFHRPGroupAssignmentList
