...
PaginatedProviderAccountList<PSCustomObject>
#>

function Initialize-PaginatedProviderAccountList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedProviderAccountList' | Write-Debug
...
Convert from JSON to PaginatedProviderAccountList<PSCustomObject>
...
PaginatedProviderAccountList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedProviderAccountList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedProviderAccountList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedProviderAccountList
