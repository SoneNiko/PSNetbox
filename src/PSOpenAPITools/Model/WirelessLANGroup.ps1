...
No description available.
.PARAMETER WirelesslanCount
No description available.
.PARAMETER Depth
No description available.
.OUTPUTS

WirelessLANGroup<PSCustomObject>
#>

function Initialize-WirelessLANGroup {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WirelessLANGroup' | Write-Debug
        ...
        if ($null -eq $WirelesslanCount) {
            throw "invalid value for 'WirelesslanCount', 'WirelesslanCount' cannot be null."
        }
        ...
        $PSO = [PSCustomObject]@{
            ...
            "wirelesslan_count" = ${WirelesslanCount}
            "_depth" = ${Depth}
        }
...
Convert from JSON to WirelessLANGroup<PSCustomObject>
...
WirelessLANGroup<PSCustomObject>
#>
function ConvertFrom-JsonToWirelessLANGroup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WirelessLANGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WirelessLANGroup
        $AllProperties = ("id", "url", "display", "name", "slug", "parent", "description", "tags", "custom_fields", "created", "last_updated", "wirelesslan_count", "_depth")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "wirelesslan_count"))) {
            throw "Error! JSON cannot be serialized due to the required property 'wirelesslan_count' missing."
        } else {
            $WirelesslanCount = $JsonParameters.PSobject.Properties["wirelesslan_count"].value
        }
