...
PowerPortTemplate<PSCustomObject>
#>

function Initialize-PowerPortTemplate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PowerPortTemplate' | Write-Debug
...
Convert from JSON to PowerPortTemplate<PSCustomObject>
...
PowerPortTemplate<PSCustomObject>
#>
function ConvertFrom-JsonToPowerPortTemplate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PowerPortTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PowerPortTemplate
        $AllProperties = ("id", "url", "display", "device_type", "module_type", "name", "label", "type", "maximum_draw", "allocated_draw", "description", "created", "last_updated")
