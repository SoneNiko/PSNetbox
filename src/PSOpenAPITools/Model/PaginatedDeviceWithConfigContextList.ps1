...
PaginatedDeviceWithConfigContextList<PSCustomObject>
#>

function Initialize-PaginatedDeviceWithConfigContextList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedDeviceWithConfigContextList' | Write-Debug
...
Convert from JSON to PaginatedDeviceWithConfigContextList<PSCustomObject>
...
PaginatedDeviceWithConfigContextList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedDeviceWithConfigContextList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedDeviceWithConfigContextList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedDeviceWithConfigContextList
