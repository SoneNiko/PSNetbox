...
function ConvertFrom-JsonToDevice {
    ...
    Process {
        ...
        $AllProperties = ("id", "url", "display", "name", "device_type", "role", "device_role", "tenant", "platform", "serial", "asset_tag", "site", "location", "rack", "position", "face", "latitude", "longitude", "parent_device", "status", "airflow", "primary_ip", "primary_ip4", "primary_ip6", "oob_ip", "cluster", "virtual_chassis", "vc_position", "vc_priority", "description", "comments", "config_template", "local_context_data", "tags", "custom_fields", "created", "last_updated", "console_port_count", "console_server_port_count", "power_port_count", "power_outlet_count", "interface_count", "front_port_count", "rear_port_count", "device_bay_count", "module_bay_count", "inventory_item_count")
