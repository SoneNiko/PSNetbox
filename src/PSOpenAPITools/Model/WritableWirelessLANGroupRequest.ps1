...
WritableWirelessLANGroupRequest<PSCustomObject>
#>

function Initialize-WritableWirelessLANGroupRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableWirelessLANGroupRequest' | Write-Debug
...
Convert from JSON to WritableWirelessLANGroupRequest<PSCustomObject>
...
WritableWirelessLANGroupRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableWirelessLANGroupRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableWirelessLANGroupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableWirelessLANGroupRequest
