...
PaginatedWirelessLANList<PSCustomObject>
#>

function Initialize-PaginatedWirelessLANList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedWirelessLANList' | Write-Debug
...
Convert from JSON to PaginatedWirelessLANList<PSCustomObject>
...
PaginatedWirelessLANList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedWirelessLANList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedWirelessLANList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedWirelessLANList
