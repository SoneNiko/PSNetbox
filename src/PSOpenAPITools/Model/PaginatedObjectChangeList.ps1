...
PaginatedObjectChangeList<PSCustomObject>
#>

function Initialize-PaginatedObjectChangeList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedObjectChangeList' | Write-Debug
...
Convert from JSON to PaginatedObjectChangeList<PSCustomObject>
...
PaginatedObjectChangeList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedObjectChangeList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedObjectChangeList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedObjectChangeList
