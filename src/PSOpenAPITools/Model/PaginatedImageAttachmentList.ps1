...
PaginatedImageAttachmentList<PSCustomObject>
#>

function Initialize-PaginatedImageAttachmentList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedImageAttachmentList' | Write-Debug
...
Convert from JSON to PaginatedImageAttachmentList<PSCustomObject>
...
PaginatedImageAttachmentList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedImageAttachmentList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedImageAttachmentList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedImageAttachmentList
