...
NestedClusterType<PSCustomObject>
#>

function Initialize-NestedClusterType {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedClusterType' | Write-Debug
...
Convert from JSON to NestedClusterType<PSCustomObject>
...
NestedClusterType<PSCustomObject>
#>
function ConvertFrom-JsonToNestedClusterType {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedClusterType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedClusterType
