...
PaginatedVirtualChassisList<PSCustomObject>
#>

function Initialize-PaginatedVirtualChassisList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedVirtualChassisList' | Write-Debug
...
Convert from JSON to PaginatedVirtualChassisList<PSCustomObject>
...
PaginatedVirtualChassisList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedVirtualChassisList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedVirtualChassisList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedVirtualChassisList
