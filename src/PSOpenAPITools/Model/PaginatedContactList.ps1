...
PaginatedContactList<PSCustomObject>
#>

function Initialize-PaginatedContactList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedContactList' | Write-Debug
...
Convert from JSON to PaginatedContactList<PSCustomObject>
...
PaginatedContactList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedContactList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedContactList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedContactList
