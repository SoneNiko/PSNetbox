...
PowerPortTemplateRequest<PSCustomObject>
#>

function Initialize-PowerPortTemplateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PowerPortTemplateRequest' | Write-Debug
...
Convert from JSON to PowerPortTemplateRequest<PSCustomObject>
...
PowerPortTemplateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPowerPortTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PowerPortTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PowerPortTemplateRequest
