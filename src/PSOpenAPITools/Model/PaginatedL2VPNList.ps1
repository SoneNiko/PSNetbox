...
PaginatedL2VPNList<PSCustomObject>
#>

function Initialize-PaginatedL2VPNList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedL2VPNList' | Write-Debug
...
Convert from JSON to PaginatedL2VPNList<PSCustomObject>
...
PaginatedL2VPNList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedL2VPNList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedL2VPNList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedL2VPNList
