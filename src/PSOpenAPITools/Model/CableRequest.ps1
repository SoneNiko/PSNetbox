...
CableRequest<PSCustomObject>
#>

function Initialize-CableRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CableRequest' | Write-Debug
...
Convert from JSON to CableRequest<PSCustomObject>
...
CableRequest<PSCustomObject>
#>
function ConvertFrom-JsonToCableRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CableRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CableRequest
