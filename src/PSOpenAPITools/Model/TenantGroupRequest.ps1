...
TenantGroupRequest<PSCustomObject>
#>

function Initialize-TenantGroupRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TenantGroupRequest' | Write-Debug
...
Convert from JSON to TenantGroupRequest<PSCustomObject>
...
TenantGroupRequest<PSCustomObject>
#>
function ConvertFrom-JsonToTenantGroupRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TenantGroupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TenantGroupRequest
