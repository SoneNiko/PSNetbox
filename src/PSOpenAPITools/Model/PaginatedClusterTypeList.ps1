...
PaginatedClusterTypeList<PSCustomObject>
#>

function Initialize-PaginatedClusterTypeList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedClusterTypeList' | Write-Debug
...
Convert from JSON to PaginatedClusterTypeList<PSCustomObject>
...
PaginatedClusterTypeList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedClusterTypeList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedClusterTypeList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedClusterTypeList
