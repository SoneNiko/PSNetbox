...
NestedVMInterface<PSCustomObject>
#>

function Initialize-NestedVMInterface {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedVMInterface' | Write-Debug
...
Convert from JSON to NestedVMInterface<PSCustomObject>
...
NestedVMInterface<PSCustomObject>
#>
function ConvertFrom-JsonToNestedVMInterface {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedVMInterface' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedVMInterface
        $AllProperties = ("id", "url", "display", "virtual_machine", "name")
