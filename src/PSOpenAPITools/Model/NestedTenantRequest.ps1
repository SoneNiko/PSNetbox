...
NestedTenantRequest<PSCustomObject>
#>

function Initialize-NestedTenantRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedTenantRequest' | Write-Debug
...
Convert from JSON to NestedTenantRequest<PSCustomObject>
...
NestedTenantRequest<PSCustomObject>
#>
function ConvertFrom-JsonToNestedTenantRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedTenantRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedTenantRequest
