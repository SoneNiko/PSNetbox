...
PaginatedCustomLinkList<PSCustomObject>
#>

function Initialize-PaginatedCustomLinkList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedCustomLinkList' | Write-Debug
...
Convert from JSON to PaginatedCustomLinkList<PSCustomObject>
...
PaginatedCustomLinkList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedCustomLinkList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedCustomLinkList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedCustomLinkList
