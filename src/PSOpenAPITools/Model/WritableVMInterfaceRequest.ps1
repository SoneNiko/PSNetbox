...
WritableVMInterfaceRequest<PSCustomObject>
#>

function Initialize-WritableVMInterfaceRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableVMInterfaceRequest' | Write-Debug
...
Convert from JSON to WritableVMInterfaceRequest<PSCustomObject>
...
WritableVMInterfaceRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableVMInterfaceRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableVMInterfaceRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableVMInterfaceRequest
