...
RearPortRequest<PSCustomObject>
#>

function Initialize-RearPortRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RearPortRequest' | Write-Debug
...
Convert from JSON to RearPortRequest<PSCustomObject>
...
RearPortRequest<PSCustomObject>
#>
function ConvertFrom-JsonToRearPortRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RearPortRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RearPortRequest
