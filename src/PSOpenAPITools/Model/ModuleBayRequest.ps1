...
ModuleBayRequest<PSCustomObject>
#>

function Initialize-ModuleBayRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModuleBayRequest' | Write-Debug
...
Convert from JSON to ModuleBayRequest<PSCustomObject>
...
ModuleBayRequest<PSCustomObject>
#>
function ConvertFrom-JsonToModuleBayRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModuleBayRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ModuleBayRequest
