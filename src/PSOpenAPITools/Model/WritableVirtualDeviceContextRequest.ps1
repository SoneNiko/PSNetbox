...
WritableVirtualDeviceContextRequest<PSCustomObject>
#>

function Initialize-WritableVirtualDeviceContextRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableVirtualDeviceContextRequest' | Write-Debug
...
Convert from JSON to WritableVirtualDeviceContextRequest<PSCustomObject>
...
WritableVirtualDeviceContextRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableVirtualDeviceContextRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableVirtualDeviceContextRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableVirtualDeviceContextRequest
