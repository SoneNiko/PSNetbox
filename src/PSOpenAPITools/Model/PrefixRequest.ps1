...
PrefixRequest<PSCustomObject>
#>

function Initialize-PrefixRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PrefixRequest' | Write-Debug
...
Convert from JSON to PrefixRequest<PSCustomObject>
...
PrefixRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPrefixRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PrefixRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrefixRequest
