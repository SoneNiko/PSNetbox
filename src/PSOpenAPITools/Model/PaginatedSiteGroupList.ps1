...
PaginatedSiteGroupList<PSCustomObject>
#>

function Initialize-PaginatedSiteGroupList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedSiteGroupList' | Write-Debug
...
Convert from JSON to PaginatedSiteGroupList<PSCustomObject>
...
PaginatedSiteGroupList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedSiteGroupList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedSiteGroupList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedSiteGroupList
