...
WritableRackRequest<PSCustomObject>
#>

function Initialize-WritableRackRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableRackRequest' | Write-Debug
...
Convert from JSON to WritableRackRequest<PSCustomObject>
...
WritableRackRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableRackRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableRackRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableRackRequest
