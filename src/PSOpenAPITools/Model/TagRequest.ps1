...
TagRequest<PSCustomObject>
#>

function Initialize-TagRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TagRequest' | Write-Debug
...
Convert from JSON to TagRequest<PSCustomObject>
...
TagRequest<PSCustomObject>
#>
function ConvertFrom-JsonToTagRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TagRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TagRequest
