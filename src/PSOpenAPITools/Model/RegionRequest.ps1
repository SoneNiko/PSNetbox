...
RegionRequest<PSCustomObject>
#>

function Initialize-RegionRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RegionRequest' | Write-Debug
...
Convert from JSON to RegionRequest<PSCustomObject>
...
RegionRequest<PSCustomObject>
#>
function ConvertFrom-JsonToRegionRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RegionRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RegionRequest
