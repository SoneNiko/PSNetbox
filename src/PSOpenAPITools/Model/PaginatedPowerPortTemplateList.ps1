...
PaginatedPowerPortTemplateList<PSCustomObject>
#>

function Initialize-PaginatedPowerPortTemplateList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedPowerPortTemplateList' | Write-Debug
...
Convert from JSON to PaginatedPowerPortTemplateList<PSCustomObject>
...
PaginatedPowerPortTemplateList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedPowerPortTemplateList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedPowerPortTemplateList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedPowerPortTemplateList
