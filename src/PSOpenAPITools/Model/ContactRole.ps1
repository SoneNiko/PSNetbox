...
ContactRole<PSCustomObject>
#>

function Initialize-ContactRole {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContactRole' | Write-Debug
...
Convert from JSON to ContactRole<PSCustomObject>
...
ContactRole<PSCustomObject>
#>
function ConvertFrom-JsonToContactRole {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContactRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ContactRole
        $AllProperties = ("id", "url", "display", "name", "slug", "description", "tags", "custom_fields", "created", "last_updated")
