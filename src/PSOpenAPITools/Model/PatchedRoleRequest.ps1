...
PatchedRoleRequest<PSCustomObject>
#>

function Initialize-PatchedRoleRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedRoleRequest' | Write-Debug
...
Convert from JSON to PatchedRoleRequest<PSCustomObject>
...
PatchedRoleRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedRoleRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedRoleRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedRoleRequest
        $AllProperties = ("name", "slug", "weight", "description", "tags", "custom_fields")
