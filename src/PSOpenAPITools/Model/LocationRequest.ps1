...
LocationRequest<PSCustomObject>
#>

function Initialize-LocationRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LocationRequest' | Write-Debug
...
Convert from JSON to LocationRequest<PSCustomObject>
...
LocationRequest<PSCustomObject>
#>
function ConvertFrom-JsonToLocationRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LocationRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LocationRequest
