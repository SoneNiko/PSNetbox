...
PaginatedProviderList<PSCustomObject>
#>

function Initialize-PaginatedProviderList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedProviderList' | Write-Debug
...
Convert from JSON to PaginatedProviderList<PSCustomObject>
...
PaginatedProviderList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedProviderList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedProviderList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedProviderList
