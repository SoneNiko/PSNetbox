...
No description available.
.PARAMETER TerminationA
No description available.
.PARAMETER TerminationZ
No description available.
.PARAMETER Comments
No description available.
.PARAMETER Tags
...
function Initialize-Circuit {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Circuit' | Write-Debug
        ...
        $PSO = [PSCustomObject]@{
            ...
            "termination_a" = ${TerminationA}
            "termination_z" = ${TerminationZ}
            "comments" = ${Comments}
            "tags" = ${Tags}
...
Convert from JSON to Circuit<PSCustomObject>
...
Circuit<PSCustomObject>
#>
function ConvertFrom-JsonToCircuit {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Circuit' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Circuit
        $AllProperties = ("id", "url", "display", "cid", "provider", "provider_account", "type", "status", "tenant", "install_date", "termination_date", "commit_rate", "description", "termination_a", "termination_z", "comments", "tags", "custom_fields", "created", "last_updated")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "termination_a"))) {
            throw "Error! JSON cannot be serialized due to the required property 'termination_a' missing."
        } else {
            $TerminationA = $JsonParameters.PSobject.Properties["termination_a"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "termination_z"))) {
            throw "Error! JSON cannot be serialized due to the required property 'termination_z' missing."
        } else {
            $TerminationZ = $JsonParameters.PSobject.Properties["termination_z"].value
        }
