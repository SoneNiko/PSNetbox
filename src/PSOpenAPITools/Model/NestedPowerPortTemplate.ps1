...
NestedPowerPortTemplate<PSCustomObject>
#>

function Initialize-NestedPowerPortTemplate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedPowerPortTemplate' | Write-Debug
...
Convert from JSON to NestedPowerPortTemplate<PSCustomObject>
...
NestedPowerPortTemplate<PSCustomObject>
#>
function ConvertFrom-JsonToNestedPowerPortTemplate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedPowerPortTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedPowerPortTemplate
