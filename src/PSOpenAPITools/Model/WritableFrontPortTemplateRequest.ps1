...
WritableFrontPortTemplateRequest<PSCustomObject>
#>

function Initialize-WritableFrontPortTemplateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableFrontPortTemplateRequest' | Write-Debug
...
Convert from JSON to WritableFrontPortTemplateRequest<PSCustomObject>
...
WritableFrontPortTemplateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableFrontPortTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableFrontPortTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableFrontPortTemplateRequest
        $AllProperties = ("device_type", "module_type", "name", "label", "type", "color", "rear_port", "rear_port_position", "description")
