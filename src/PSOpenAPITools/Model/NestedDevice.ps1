...
NestedDevice<PSCustomObject>
#>

function Initialize-NestedDevice {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedDevice' | Write-Debug
...
Convert from JSON to NestedDevice<PSCustomObject>
...
NestedDevice<PSCustomObject>
#>
function ConvertFrom-JsonToNestedDevice {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedDevice' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedDevice
