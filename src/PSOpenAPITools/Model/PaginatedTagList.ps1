...
PaginatedTagList<PSCustomObject>
#>

function Initialize-PaginatedTagList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedTagList' | Write-Debug
...
Convert from JSON to PaginatedTagList<PSCustomObject>
...
PaginatedTagList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedTagList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedTagList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedTagList
