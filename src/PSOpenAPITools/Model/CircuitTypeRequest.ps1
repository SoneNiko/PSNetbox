...
CircuitTypeRequest<PSCustomObject>
#>

function Initialize-CircuitTypeRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CircuitTypeRequest' | Write-Debug
...
Convert from JSON to CircuitTypeRequest<PSCustomObject>
...
CircuitTypeRequest<PSCustomObject>
#>
function ConvertFrom-JsonToCircuitTypeRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CircuitTypeRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CircuitTypeRequest
