...
NestedDataSource<PSCustomObject>
#>

function Initialize-NestedDataSource {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedDataSource' | Write-Debug
...
Convert from JSON to NestedDataSource<PSCustomObject>
...
NestedDataSource<PSCustomObject>
#>
function ConvertFrom-JsonToNestedDataSource {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedDataSource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedDataSource
