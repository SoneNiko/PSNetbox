...
ModuleRequest<PSCustomObject>
#>

function Initialize-ModuleRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModuleRequest' | Write-Debug
...
Convert from JSON to ModuleRequest<PSCustomObject>
...
ModuleRequest<PSCustomObject>
#>
function ConvertFrom-JsonToModuleRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModuleRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ModuleRequest
