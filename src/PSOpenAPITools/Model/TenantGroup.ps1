...
TenantGroup<PSCustomObject>
#>

function Initialize-TenantGroup {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TenantGroup' | Write-Debug
        ...
        if ($null -eq $TenantCount) {
            throw "invalid value for 'TenantCount', 'TenantCount' cannot be null."
        }
...
Convert from JSON to TenantGroup<PSCustomObject>
...
TenantGroup<PSCustomObject>
#>
function ConvertFrom-JsonToTenantGroup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TenantGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TenantGroup
        $AllProperties = ("id", "url", "display", "name", "slug", "parent", "description", "tags", "custom_fields", "created", "last_updated", "tenant_count", "_depth")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "tenant_count"))) {
            throw "Error! JSON cannot be serialized due to the required property 'tenant_count' missing."
        } else {
            $TenantCount = $JsonParameters.PSobject.Properties["tenant_count"].value
        }
