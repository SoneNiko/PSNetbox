...
PaginatedRearPortList<PSCustomObject>
#>

function Initialize-PaginatedRearPortList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedRearPortList' | Write-Debug
...
Convert from JSON to PaginatedRearPortList<PSCustomObject>
...
PaginatedRearPortList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedRearPortList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedRearPortList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedRearPortList
