...
ProviderNetwork<PSCustomObject>
#>

function Initialize-ProviderNetwork {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProviderNetwork' | Write-Debug
...
Convert from JSON to ProviderNetwork<PSCustomObject>
...
ProviderNetwork<PSCustomObject>
#>
function ConvertFrom-JsonToProviderNetwork {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProviderNetwork' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProviderNetwork
        $AllProperties = ("id", "url", "display", "provider", "name", "service_id", "description", "comments", "tags", "custom_fields", "created", "last_updated")
