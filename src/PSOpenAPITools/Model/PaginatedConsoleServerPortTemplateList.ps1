...
PaginatedConsoleServerPortTemplateList<PSCustomObject>
#>

function Initialize-PaginatedConsoleServerPortTemplateList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedConsoleServerPortTemplateList' | Write-Debug
...
Convert from JSON to PaginatedConsoleServerPortTemplateList<PSCustomObject>
...
PaginatedConsoleServerPortTemplateList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedConsoleServerPortTemplateList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedConsoleServerPortTemplateList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedConsoleServerPortTemplateList
