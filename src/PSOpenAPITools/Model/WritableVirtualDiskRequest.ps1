...
WritableVirtualDiskRequest<PSCustomObject>
#>

function Initialize-WritableVirtualDiskRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableVirtualDiskRequest' | Write-Debug
...
Convert from JSON to WritableVirtualDiskRequest<PSCustomObject>
...
WritableVirtualDiskRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableVirtualDiskRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableVirtualDiskRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableVirtualDiskRequest
