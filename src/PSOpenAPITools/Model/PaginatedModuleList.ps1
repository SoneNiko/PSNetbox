...
PaginatedModuleList<PSCustomObject>
#>

function Initialize-PaginatedModuleList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedModuleList' | Write-Debug
...
Convert from JSON to PaginatedModuleList<PSCustomObject>
...
PaginatedModuleList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedModuleList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedModuleList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedModuleList
