...
WritableCableRequest<PSCustomObject>
#>

function Initialize-WritableCableRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableCableRequest' | Write-Debug
...
Convert from JSON to WritableCableRequest<PSCustomObject>
...
WritableCableRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableCableRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableCableRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableCableRequest
