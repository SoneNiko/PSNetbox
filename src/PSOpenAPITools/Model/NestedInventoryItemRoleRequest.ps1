...
NestedInventoryItemRoleRequest<PSCustomObject>
#>

function Initialize-NestedInventoryItemRoleRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedInventoryItemRoleRequest' | Write-Debug
...
Convert from JSON to NestedInventoryItemRoleRequest<PSCustomObject>
...
NestedInventoryItemRoleRequest<PSCustomObject>
#>
function ConvertFrom-JsonToNestedInventoryItemRoleRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedInventoryItemRoleRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedInventoryItemRoleRequest
