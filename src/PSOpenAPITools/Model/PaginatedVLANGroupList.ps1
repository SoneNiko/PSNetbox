...
PaginatedVLANGroupList<PSCustomObject>
#>

function Initialize-PaginatedVLANGroupList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedVLANGroupList' | Write-Debug
...
Convert from JSON to PaginatedVLANGroupList<PSCustomObject>
...
PaginatedVLANGroupList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedVLANGroupList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedVLANGroupList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedVLANGroupList
