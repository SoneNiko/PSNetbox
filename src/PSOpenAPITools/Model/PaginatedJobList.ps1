...
PaginatedJobList<PSCustomObject>
#>

function Initialize-PaginatedJobList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedJobList' | Write-Debug
...
Convert from JSON to PaginatedJobList<PSCustomObject>
...
PaginatedJobList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedJobList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedJobList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedJobList
