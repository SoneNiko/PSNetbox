...
WritableDataSourceRequest<PSCustomObject>
#>

function Initialize-WritableDataSourceRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableDataSourceRequest' | Write-Debug
...
Convert from JSON to WritableDataSourceRequest<PSCustomObject>
...
WritableDataSourceRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableDataSourceRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableDataSourceRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableDataSourceRequest
