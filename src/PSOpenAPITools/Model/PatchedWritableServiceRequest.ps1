...
PatchedWritableServiceRequest<PSCustomObject>
#>

function Initialize-PatchedWritableServiceRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableServiceRequest' | Write-Debug
...
Convert from JSON to PatchedWritableServiceRequest<PSCustomObject>
...
PatchedWritableServiceRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableServiceRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableServiceRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableServiceRequest
