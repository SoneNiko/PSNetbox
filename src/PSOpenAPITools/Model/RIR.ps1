...
function Initialize-RIR {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RIR' | Write-Debug
        ...
        if ($null -eq $AggregateCount) {
            throw "invalid value for 'AggregateCount', 'AggregateCount' cannot be null."
        }
...
Convert from JSON to RIR<PSCustomObject>
...
RIR<PSCustomObject>
#>
function ConvertFrom-JsonToRIR {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RIR' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RIR
        $AllProperties = ("id", "url", "display", "name", "slug", "is_private", "description", "tags", "custom_fields", "created", "last_updated", "aggregate_count")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "aggregate_count"))) {
            throw "Error! JSON cannot be serialized due to the required property 'aggregate_count' missing."
        } else {
            $AggregateCount = $JsonParameters.PSobject.Properties["aggregate_count"].value
        }
