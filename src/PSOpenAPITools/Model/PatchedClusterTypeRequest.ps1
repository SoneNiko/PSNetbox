...
PatchedClusterTypeRequest<PSCustomObject>
#>

function Initialize-PatchedClusterTypeRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedClusterTypeRequest' | Write-Debug
...
Convert from JSON to PatchedClusterTypeRequest<PSCustomObject>
...
PatchedClusterTypeRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedClusterTypeRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedClusterTypeRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedClusterTypeRequest
