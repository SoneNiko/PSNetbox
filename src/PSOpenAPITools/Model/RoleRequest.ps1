...
RoleRequest<PSCustomObject>
#>

function Initialize-RoleRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RoleRequest' | Write-Debug
...
Convert from JSON to RoleRequest<PSCustomObject>
...
RoleRequest<PSCustomObject>
#>
function ConvertFrom-JsonToRoleRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RoleRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RoleRequest
