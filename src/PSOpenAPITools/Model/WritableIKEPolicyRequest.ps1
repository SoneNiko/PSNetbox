...
WritableIKEPolicyRequest<PSCustomObject>
#>

function Initialize-WritableIKEPolicyRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableIKEPolicyRequest' | Write-Debug
...
Convert from JSON to WritableIKEPolicyRequest<PSCustomObject>
...
WritableIKEPolicyRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableIKEPolicyRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableIKEPolicyRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableIKEPolicyRequest
