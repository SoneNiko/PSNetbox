...
PaginatedEventRuleList<PSCustomObject>
#>

function Initialize-PaginatedEventRuleList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedEventRuleList' | Write-Debug
...
Convert from JSON to PaginatedEventRuleList<PSCustomObject>
...
PaginatedEventRuleList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedEventRuleList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedEventRuleList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedEventRuleList
