...
WritableUserRequest<PSCustomObject>
#>

function Initialize-WritableUserRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableUserRequest' | Write-Debug
...
Convert from JSON to WritableUserRequest<PSCustomObject>
...
WritableUserRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableUserRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableUserRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableUserRequest
