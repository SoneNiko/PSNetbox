...
IPSecProfile<PSCustomObject>
#>

function Initialize-IPSecProfile {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IPSecProfile' | Write-Debug
...
Convert from JSON to IPSecProfile<PSCustomObject>
...
IPSecProfile<PSCustomObject>
#>
function ConvertFrom-JsonToIPSecProfile {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IPSecProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IPSecProfile
        $AllProperties = ("id", "url", "display", "name", "description", "mode", "ike_policy", "ipsec_policy", "comments", "tags", "custom_fields", "created", "last_updated")
