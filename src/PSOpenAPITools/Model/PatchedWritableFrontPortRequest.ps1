...
PatchedWritableFrontPortRequest<PSCustomObject>
#>

function Initialize-PatchedWritableFrontPortRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableFrontPortRequest' | Write-Debug
...
Convert from JSON to PatchedWritableFrontPortRequest<PSCustomObject>
...
PatchedWritableFrontPortRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableFrontPortRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableFrontPortRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableFrontPortRequest
