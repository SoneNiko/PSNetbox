...
PaginatedServiceTemplateList<PSCustomObject>
#>

function Initialize-PaginatedServiceTemplateList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedServiceTemplateList' | Write-Debug
...
Convert from JSON to PaginatedServiceTemplateList<PSCustomObject>
...
PaginatedServiceTemplateList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedServiceTemplateList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedServiceTemplateList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedServiceTemplateList
