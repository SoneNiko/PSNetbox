...
NestedProviderRequest<PSCustomObject>
#>

function Initialize-NestedProviderRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedProviderRequest' | Write-Debug
...
Convert from JSON to NestedProviderRequest<PSCustomObject>
...
NestedProviderRequest<PSCustomObject>
#>
function ConvertFrom-JsonToNestedProviderRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedProviderRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedProviderRequest
