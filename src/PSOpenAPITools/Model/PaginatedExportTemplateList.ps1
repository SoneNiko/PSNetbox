...
PaginatedExportTemplateList<PSCustomObject>
#>

function Initialize-PaginatedExportTemplateList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedExportTemplateList' | Write-Debug
...
Convert from JSON to PaginatedExportTemplateList<PSCustomObject>
...
PaginatedExportTemplateList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedExportTemplateList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedExportTemplateList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedExportTemplateList
