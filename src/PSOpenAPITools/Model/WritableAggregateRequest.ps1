...
WritableAggregateRequest<PSCustomObject>
#>

function Initialize-WritableAggregateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableAggregateRequest' | Write-Debug
...
Convert from JSON to WritableAggregateRequest<PSCustomObject>
...
WritableAggregateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableAggregateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableAggregateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableAggregateRequest
