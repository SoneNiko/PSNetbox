...
VirtualDiskRequest<PSCustomObject>
#>

function Initialize-VirtualDiskRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => VirtualDiskRequest' | Write-Debug
...
Convert from JSON to VirtualDiskRequest<PSCustomObject>
...
VirtualDiskRequest<PSCustomObject>
#>
function ConvertFrom-JsonToVirtualDiskRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => VirtualDiskRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VirtualDiskRequest
