...
PatchedWritableDeviceTypeRequest<PSCustomObject>
#>

function Initialize-PatchedWritableDeviceTypeRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableDeviceTypeRequest' | Write-Debug
        ...
        if (!$Model -and $Model.length -lt 1) {
...
Convert from JSON to PatchedWritableDeviceTypeRequest<PSCustomObject>
...
PatchedWritableDeviceTypeRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableDeviceTypeRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableDeviceTypeRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableDeviceTypeRequest
