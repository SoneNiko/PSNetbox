...
PatchedWritablePowerOutletTemplateRequest<PSCustomObject>
#>

function Initialize-PatchedWritablePowerOutletTemplateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritablePowerOutletTemplateRequest' | Write-Debug
...
Convert from JSON to PatchedWritablePowerOutletTemplateRequest<PSCustomObject>
...
PatchedWritablePowerOutletTemplateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritablePowerOutletTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritablePowerOutletTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritablePowerOutletTemplateRequest
        $AllProperties = ("device_type", "module_type", "name", "label", "type", "power_port", "feed_leg", "description")
