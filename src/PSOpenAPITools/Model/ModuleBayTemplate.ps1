...
ModuleBayTemplate<PSCustomObject>
#>

function Initialize-ModuleBayTemplate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModuleBayTemplate' | Write-Debug
...
Convert from JSON to ModuleBayTemplate<PSCustomObject>
...
ModuleBayTemplate<PSCustomObject>
#>
function ConvertFrom-JsonToModuleBayTemplate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModuleBayTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ModuleBayTemplate
        $AllProperties = ("id", "url", "display", "device_type", "name", "label", "position", "description", "created", "last_updated")
