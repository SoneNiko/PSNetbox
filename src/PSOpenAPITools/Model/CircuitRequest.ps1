...
CircuitRequest<PSCustomObject>
#>

function Initialize-CircuitRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CircuitRequest' | Write-Debug
...
Convert from JSON to CircuitRequest<PSCustomObject>
...
CircuitRequest<PSCustomObject>
#>
function ConvertFrom-JsonToCircuitRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CircuitRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CircuitRequest
