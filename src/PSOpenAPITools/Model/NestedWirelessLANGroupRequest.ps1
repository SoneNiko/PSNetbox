...
NestedWirelessLANGroupRequest<PSCustomObject>
#>

function Initialize-NestedWirelessLANGroupRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedWirelessLANGroupRequest' | Write-Debug
...
Convert from JSON to NestedWirelessLANGroupRequest<PSCustomObject>
...
NestedWirelessLANGroupRequest<PSCustomObject>
#>
function ConvertFrom-JsonToNestedWirelessLANGroupRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedWirelessLANGroupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedWirelessLANGroupRequest
