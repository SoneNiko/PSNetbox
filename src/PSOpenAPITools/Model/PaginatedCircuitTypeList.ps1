...
PaginatedCircuitTypeList<PSCustomObject>
#>

function Initialize-PaginatedCircuitTypeList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedCircuitTypeList' | Write-Debug
...
Convert from JSON to PaginatedCircuitTypeList<PSCustomObject>
...
PaginatedCircuitTypeList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedCircuitTypeList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedCircuitTypeList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedCircuitTypeList
