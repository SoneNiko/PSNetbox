...
NestedRearPortTemplate<PSCustomObject>
#>

function Initialize-NestedRearPortTemplate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedRearPortTemplate' | Write-Debug
...
Convert from JSON to NestedRearPortTemplate<PSCustomObject>
...
NestedRearPortTemplate<PSCustomObject>
#>
function ConvertFrom-JsonToNestedRearPortTemplate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedRearPortTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedRearPortTemplate
