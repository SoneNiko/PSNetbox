...
PatchedWritableLocationRequest<PSCustomObject>
#>

function Initialize-PatchedWritableLocationRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableLocationRequest' | Write-Debug
...
Convert from JSON to PatchedWritableLocationRequest<PSCustomObject>
...
PatchedWritableLocationRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableLocationRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableLocationRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableLocationRequest
        $AllProperties = ("name", "slug", "site", "parent", "status", "tenant", "description", "tags", "custom_fields")
