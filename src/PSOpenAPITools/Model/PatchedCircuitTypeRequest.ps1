...
PatchedCircuitTypeRequest<PSCustomObject>
#>

function Initialize-PatchedCircuitTypeRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedCircuitTypeRequest' | Write-Debug
...
Convert from JSON to PatchedCircuitTypeRequest<PSCustomObject>
...
PatchedCircuitTypeRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedCircuitTypeRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedCircuitTypeRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedCircuitTypeRequest
