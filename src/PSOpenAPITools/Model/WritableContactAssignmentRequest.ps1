...
WritableContactAssignmentRequest<PSCustomObject>
#>

function Initialize-WritableContactAssignmentRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableContactAssignmentRequest' | Write-Debug
...
Convert from JSON to WritableContactAssignmentRequest<PSCustomObject>
...
WritableContactAssignmentRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableContactAssignmentRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableContactAssignmentRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableContactAssignmentRequest
