...
WritableVirtualMachineWithConfigContextRequest<PSCustomObject>
#>

function Initialize-WritableVirtualMachineWithConfigContextRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableVirtualMachineWithConfigContextRequest' | Write-Debug
...
Convert from JSON to WritableVirtualMachineWithConfigContextRequest<PSCustomObject>
...
WritableVirtualMachineWithConfigContextRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableVirtualMachineWithConfigContextRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableVirtualMachineWithConfigContextRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableVirtualMachineWithConfigContextRequest
