...
PatchedWritableDeviceRoleRequest<PSCustomObject>
#>

function Initialize-PatchedWritableDeviceRoleRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableDeviceRoleRequest' | Write-Debug
...
Convert from JSON to PatchedWritableDeviceRoleRequest<PSCustomObject>
...
PatchedWritableDeviceRoleRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableDeviceRoleRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableDeviceRoleRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableDeviceRoleRequest
