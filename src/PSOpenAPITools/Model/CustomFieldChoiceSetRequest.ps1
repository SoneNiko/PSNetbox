...
CustomFieldChoiceSetRequest<PSCustomObject>
#>

function Initialize-CustomFieldChoiceSetRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CustomFieldChoiceSetRequest' | Write-Debug
...
Convert from JSON to CustomFieldChoiceSetRequest<PSCustomObject>
...
CustomFieldChoiceSetRequest<PSCustomObject>
#>
function ConvertFrom-JsonToCustomFieldChoiceSetRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CustomFieldChoiceSetRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CustomFieldChoiceSetRequest
