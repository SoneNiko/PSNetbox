...
PaginatedWebhookList<PSCustomObject>
#>

function Initialize-PaginatedWebhookList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedWebhookList' | Write-Debug
...
Convert from JSON to PaginatedWebhookList<PSCustomObject>
...
PaginatedWebhookList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedWebhookList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedWebhookList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedWebhookList
