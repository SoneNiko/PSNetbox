...
RIRRequest<PSCustomObject>
#>

function Initialize-RIRRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RIRRequest' | Write-Debug
...
Convert from JSON to RIRRequest<PSCustomObject>
...
RIRRequest<PSCustomObject>
#>
function ConvertFrom-JsonToRIRRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RIRRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RIRRequest
