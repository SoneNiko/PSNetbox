...
NestedProvider<PSCustomObject>
#>

function Initialize-NestedProvider {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedProvider' | Write-Debug
...
Convert from JSON to NestedProvider<PSCustomObject>
...
NestedProvider<PSCustomObject>
#>
function ConvertFrom-JsonToNestedProvider {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedProvider' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedProvider
