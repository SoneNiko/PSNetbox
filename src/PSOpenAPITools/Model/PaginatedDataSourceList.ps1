...
PaginatedDataSourceList<PSCustomObject>
#>

function Initialize-PaginatedDataSourceList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedDataSourceList' | Write-Debug
...
Convert from JSON to PaginatedDataSourceList<PSCustomObject>
...
PaginatedDataSourceList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedDataSourceList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedDataSourceList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedDataSourceList
