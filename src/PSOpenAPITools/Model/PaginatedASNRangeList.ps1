...
PaginatedASNRangeList<PSCustomObject>
#>

function Initialize-PaginatedASNRangeList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedASNRangeList' | Write-Debug
...
Convert from JSON to PaginatedASNRangeList<PSCustomObject>
...
PaginatedASNRangeList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedASNRangeList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedASNRangeList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedASNRangeList
