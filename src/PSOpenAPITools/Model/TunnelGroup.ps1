...
TunnelGroup<PSCustomObject>
#>

function Initialize-TunnelGroup {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TunnelGroup' | Write-Debug
        ...
        if ($null -eq $TunnelCount) {
            throw "invalid value for 'TunnelCount', 'TunnelCount' cannot be null."
        }
...
Convert from JSON to TunnelGroup<PSCustomObject>
...
TunnelGroup<PSCustomObject>
#>
function ConvertFrom-JsonToTunnelGroup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TunnelGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TunnelGroup
        $AllProperties = ("id", "url", "display", "name", "slug", "description", "tags", "custom_fields", "created", "last_updated", "tunnel_count")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "tunnel_count"))) {
            throw "Error! JSON cannot be serialized due to the required property 'tunnel_count' missing."
        } else {
            $TunnelCount = $JsonParameters.PSobject.Properties["tunnel_count"].value
        }
