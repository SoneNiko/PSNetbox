...
NestedCircuit<PSCustomObject>
#>

function Initialize-NestedCircuit {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedCircuit' | Write-Debug
...
Convert from JSON to NestedCircuit<PSCustomObject>
...
NestedCircuit<PSCustomObject>
#>
function ConvertFrom-JsonToNestedCircuit {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedCircuit' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedCircuit
        $AllProperties = ("id", "url", "display", "cid")
