...
PaginatedPlatformList<PSCustomObject>
#>

function Initialize-PaginatedPlatformList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedPlatformList' | Write-Debug
...
Convert from JSON to PaginatedPlatformList<PSCustomObject>
...
PaginatedPlatformList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedPlatformList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedPlatformList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedPlatformList
