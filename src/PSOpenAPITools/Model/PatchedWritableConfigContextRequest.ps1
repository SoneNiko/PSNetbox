...
PatchedWritableConfigContextRequest<PSCustomObject>
#>

function Initialize-PatchedWritableConfigContextRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableConfigContextRequest' | Write-Debug
...
Convert from JSON to PatchedWritableConfigContextRequest<PSCustomObject>
...
PatchedWritableConfigContextRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableConfigContextRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableConfigContextRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableConfigContextRequest
