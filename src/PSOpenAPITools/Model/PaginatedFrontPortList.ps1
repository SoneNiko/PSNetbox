...
PaginatedFrontPortList<PSCustomObject>
#>

function Initialize-PaginatedFrontPortList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedFrontPortList' | Write-Debug
...
Convert from JSON to PaginatedFrontPortList<PSCustomObject>
...
PaginatedFrontPortList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedFrontPortList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedFrontPortList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedFrontPortList
