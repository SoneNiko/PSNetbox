...
ConfigContextRequest<PSCustomObject>
#>

function Initialize-ConfigContextRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ConfigContextRequest' | Write-Debug
...
Convert from JSON to ConfigContextRequest<PSCustomObject>
...
ConfigContextRequest<PSCustomObject>
#>
function ConvertFrom-JsonToConfigContextRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ConfigContextRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ConfigContextRequest
