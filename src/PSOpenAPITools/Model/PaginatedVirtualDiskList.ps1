...
PaginatedVirtualDiskList<PSCustomObject>
#>

function Initialize-PaginatedVirtualDiskList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedVirtualDiskList' | Write-Debug
...
Convert from JSON to PaginatedVirtualDiskList<PSCustomObject>
...
PaginatedVirtualDiskList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedVirtualDiskList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedVirtualDiskList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedVirtualDiskList
