...
ServiceRequest<PSCustomObject>
#>

function Initialize-ServiceRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ServiceRequest' | Write-Debug
...
Convert from JSON to ServiceRequest<PSCustomObject>
...
ServiceRequest<PSCustomObject>
#>
function ConvertFrom-JsonToServiceRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ServiceRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ServiceRequest
