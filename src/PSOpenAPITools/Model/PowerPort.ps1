...
PowerPort<PSCustomObject>
#>

function Initialize-PowerPort {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PowerPort' | Write-Debug
...
Convert from JSON to PowerPort<PSCustomObject>
...
PowerPort<PSCustomObject>
#>
function ConvertFrom-JsonToPowerPort {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PowerPort' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PowerPort
        $AllProperties = ("id", "url", "display", "device", "module", "name", "label", "type", "maximum_draw", "allocated_draw", "description", "mark_connected", "cable", "cable_end", "link_peers", "link_peers_type", "connected_endpoints", "connected_endpoints_type", "connected_endpoints_reachable", "tags", "custom_fields", "created", "last_updated", "_occupied")
