...
PaginatedRIRList<PSCustomObject>
#>

function Initialize-PaginatedRIRList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedRIRList' | Write-Debug
...
Convert from JSON to PaginatedRIRList<PSCustomObject>
...
PaginatedRIRList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedRIRList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedRIRList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedRIRList
