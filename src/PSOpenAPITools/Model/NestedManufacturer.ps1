...
NestedManufacturer<PSCustomObject>
#>

function Initialize-NestedManufacturer {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedManufacturer' | Write-Debug
...
Convert from JSON to NestedManufacturer<PSCustomObject>
...
NestedManufacturer<PSCustomObject>
#>
function ConvertFrom-JsonToNestedManufacturer {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedManufacturer' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedManufacturer
