...
PaginatedDeviceBayTemplateList<PSCustomObject>
#>

function Initialize-PaginatedDeviceBayTemplateList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedDeviceBayTemplateList' | Write-Debug
...
Convert from JSON to PaginatedDeviceBayTemplateList<PSCustomObject>
...
PaginatedDeviceBayTemplateList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedDeviceBayTemplateList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedDeviceBayTemplateList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedDeviceBayTemplateList
