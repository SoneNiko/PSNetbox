...
NestedLocationRequest<PSCustomObject>
#>

function Initialize-NestedLocationRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedLocationRequest' | Write-Debug
...
Convert from JSON to NestedLocationRequest<PSCustomObject>
...
NestedLocationRequest<PSCustomObject>
#>
function ConvertFrom-JsonToNestedLocationRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedLocationRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedLocationRequest
