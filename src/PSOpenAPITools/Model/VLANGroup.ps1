...
VLANGroup<PSCustomObject>
#>

function Initialize-VLANGroup {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => VLANGroup' | Write-Debug
        ...
        if ($null -eq $Utilization) {
            throw "invalid value for 'Utilization', 'Utilization' cannot be null."
        }
...
Convert from JSON to VLANGroup<PSCustomObject>
...
VLANGroup<PSCustomObject>
#>
function ConvertFrom-JsonToVLANGroup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => VLANGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VLANGroup
        $AllProperties = ("id", "url", "display", "name", "slug", "scope_type", "scope_id", "scope", "min_vid", "max_vid", "description", "tags", "custom_fields", "created", "last_updated", "vlan_count", "utilization")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "utilization"))) {
            throw "Error! JSON cannot be serialized due to the required property 'utilization' missing."
        } else {
