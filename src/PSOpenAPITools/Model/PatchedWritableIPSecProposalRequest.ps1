...
PatchedWritableIPSecProposalRequest<PSCustomObject>
#>

function Initialize-PatchedWritableIPSecProposalRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableIPSecProposalRequest' | Write-Debug
...
Convert from JSON to PatchedWritableIPSecProposalRequest<PSCustomObject>
...
PatchedWritableIPSecProposalRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableIPSecProposalRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableIPSecProposalRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableIPSecProposalRequest
