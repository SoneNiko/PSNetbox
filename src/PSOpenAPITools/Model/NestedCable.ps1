...
NestedCable<PSCustomObject>
#>

function Initialize-NestedCable {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedCable' | Write-Debug
...
Convert from JSON to NestedCable<PSCustomObject>
...
NestedCable<PSCustomObject>
#>
function ConvertFrom-JsonToNestedCable {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedCable' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedCable
        $AllProperties = ("id", "url", "display", "label")
