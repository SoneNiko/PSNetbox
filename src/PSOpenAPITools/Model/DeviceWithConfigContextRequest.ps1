...
DeviceWithConfigContextRequest<PSCustomObject>
#>

function Initialize-DeviceWithConfigContextRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DeviceWithConfigContextRequest' | Write-Debug
...
Convert from JSON to DeviceWithConfigContextRequest<PSCustomObject>
...
DeviceWithConfigContextRequest<PSCustomObject>
#>
function ConvertFrom-JsonToDeviceWithConfigContextRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DeviceWithConfigContextRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeviceWithConfigContextRequest
