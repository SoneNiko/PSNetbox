...
PaginatedContentTypeList<PSCustomObject>
#>

function Initialize-PaginatedContentTypeList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedContentTypeList' | Write-Debug
...
Convert from JSON to PaginatedContentTypeList<PSCustomObject>
...
PaginatedContentTypeList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedContentTypeList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedContentTypeList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedContentTypeList
