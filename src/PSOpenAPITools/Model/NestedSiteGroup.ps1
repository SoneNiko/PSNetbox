...
NestedSiteGroup<PSCustomObject>
#>

function Initialize-NestedSiteGroup {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedSiteGroup' | Write-Debug
...
Convert from JSON to NestedSiteGroup<PSCustomObject>
...
NestedSiteGroup<PSCustomObject>
#>
function ConvertFrom-JsonToNestedSiteGroup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedSiteGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedSiteGroup
