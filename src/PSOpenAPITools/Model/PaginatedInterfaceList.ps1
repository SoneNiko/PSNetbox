...
PaginatedInterfaceList<PSCustomObject>
#>

function Initialize-PaginatedInterfaceList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedInterfaceList' | Write-Debug
...
Convert from JSON to PaginatedInterfaceList<PSCustomObject>
...
PaginatedInterfaceList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedInterfaceList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedInterfaceList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedInterfaceList
