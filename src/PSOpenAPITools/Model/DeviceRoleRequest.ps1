...
DeviceRoleRequest<PSCustomObject>
#>

function Initialize-DeviceRoleRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DeviceRoleRequest' | Write-Debug
...
Convert from JSON to DeviceRoleRequest<PSCustomObject>
...
DeviceRoleRequest<PSCustomObject>
#>
function ConvertFrom-JsonToDeviceRoleRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DeviceRoleRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeviceRoleRequest
