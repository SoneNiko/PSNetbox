...
PaginatedConsolePortTemplateList<PSCustomObject>
#>

function Initialize-PaginatedConsolePortTemplateList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedConsolePortTemplateList' | Write-Debug
...
Convert from JSON to PaginatedConsolePortTemplateList<PSCustomObject>
...
PaginatedConsolePortTemplateList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedConsolePortTemplateList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedConsolePortTemplateList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedConsolePortTemplateList
