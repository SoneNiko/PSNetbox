...
PatchedWritableFrontPortTemplateRequest<PSCustomObject>
#>

function Initialize-PatchedWritableFrontPortTemplateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableFrontPortTemplateRequest' | Write-Debug
...
Convert from JSON to PatchedWritableFrontPortTemplateRequest<PSCustomObject>
...
PatchedWritableFrontPortTemplateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableFrontPortTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableFrontPortTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableFrontPortTemplateRequest
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "rear_port"))) { #optional property not found
            $RearPort = $null
        } else {
