...
PaginatedModuleBayList<PSCustomObject>
#>

function Initialize-PaginatedModuleBayList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedModuleBayList' | Write-Debug
...
Convert from JSON to PaginatedModuleBayList<PSCustomObject>
...
PaginatedModuleBayList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedModuleBayList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedModuleBayList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedModuleBayList
