...
WritableContactGroupRequest<PSCustomObject>
#>

function Initialize-WritableContactGroupRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableContactGroupRequest' | Write-Debug
...
Convert from JSON to WritableContactGroupRequest<PSCustomObject>
...
WritableContactGroupRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableContactGroupRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableContactGroupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableContactGroupRequest
