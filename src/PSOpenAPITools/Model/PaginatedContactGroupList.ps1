...
PaginatedContactGroupList<PSCustomObject>
#>

function Initialize-PaginatedContactGroupList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedContactGroupList' | Write-Debug
...
Convert from JSON to PaginatedContactGroupList<PSCustomObject>
...
PaginatedContactGroupList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedContactGroupList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedContactGroupList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedContactGroupList
