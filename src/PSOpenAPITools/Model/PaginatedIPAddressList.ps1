...
PaginatedIPAddressList<PSCustomObject>
#>

function Initialize-PaginatedIPAddressList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedIPAddressList' | Write-Debug
...
Convert from JSON to PaginatedIPAddressList<PSCustomObject>
...
PaginatedIPAddressList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedIPAddressList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedIPAddressList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedIPAddressList
