...
WritableModuleTypeRequest<PSCustomObject>
#>

function Initialize-WritableModuleTypeRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableModuleTypeRequest' | Write-Debug
...
Convert from JSON to WritableModuleTypeRequest<PSCustomObject>
...
WritableModuleTypeRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableModuleTypeRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableModuleTypeRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableModuleTypeRequest
