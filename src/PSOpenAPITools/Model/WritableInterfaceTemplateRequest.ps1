...
WritableInterfaceTemplateRequest<PSCustomObject>
#>

function Initialize-WritableInterfaceTemplateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableInterfaceTemplateRequest' | Write-Debug
...
Convert from JSON to WritableInterfaceTemplateRequest<PSCustomObject>
...
WritableInterfaceTemplateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableInterfaceTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableInterfaceTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableInterfaceTemplateRequest
