...
PaginatedWirelessLinkList<PSCustomObject>
#>

function Initialize-PaginatedWirelessLinkList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedWirelessLinkList' | Write-Debug
...
Convert from JSON to PaginatedWirelessLinkList<PSCustomObject>
...
PaginatedWirelessLinkList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedWirelessLinkList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedWirelessLinkList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedWirelessLinkList
