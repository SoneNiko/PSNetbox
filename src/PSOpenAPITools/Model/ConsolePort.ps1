...
ConsolePort<PSCustomObject>
#>

function Initialize-ConsolePort {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ConsolePort' | Write-Debug
...
Convert from JSON to ConsolePort<PSCustomObject>
...
ConsolePort<PSCustomObject>
#>
function ConvertFrom-JsonToConsolePort {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ConsolePort' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ConsolePort
