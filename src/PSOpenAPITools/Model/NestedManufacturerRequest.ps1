...
NestedManufacturerRequest<PSCustomObject>
#>

function Initialize-NestedManufacturerRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedManufacturerRequest' | Write-Debug
...
Convert from JSON to NestedManufacturerRequest<PSCustomObject>
...
NestedManufacturerRequest<PSCustomObject>
#>
function ConvertFrom-JsonToNestedManufacturerRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedManufacturerRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedManufacturerRequest
