...
PaginatedVirtualMachineWithConfigContextList<PSCustomObject>
#>

function Initialize-PaginatedVirtualMachineWithConfigContextList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedVirtualMachineWithConfigContextList' | Write-Debug
...
Convert from JSON to PaginatedVirtualMachineWithConfigContextList<PSCustomObject>
...
PaginatedVirtualMachineWithConfigContextList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedVirtualMachineWithConfigContextList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedVirtualMachineWithConfigContextList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedVirtualMachineWithConfigContextList
