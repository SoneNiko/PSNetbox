...
WritableRearPortTemplateRequest<PSCustomObject>
#>

function Initialize-WritableRearPortTemplateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableRearPortTemplateRequest' | Write-Debug
...
Convert from JSON to WritableRearPortTemplateRequest<PSCustomObject>
...
WritableRearPortTemplateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableRearPortTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableRearPortTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableRearPortTemplateRequest
