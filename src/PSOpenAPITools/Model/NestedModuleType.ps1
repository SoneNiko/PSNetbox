...
NestedModuleType<PSCustomObject>
#>

function Initialize-NestedModuleType {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedModuleType' | Write-Debug
...
Convert from JSON to NestedModuleType<PSCustomObject>
...
NestedModuleType<PSCustomObject>
#>
function ConvertFrom-JsonToNestedModuleType {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedModuleType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedModuleType
        $AllProperties = ("id", "url", "display", "manufacturer", "model")
