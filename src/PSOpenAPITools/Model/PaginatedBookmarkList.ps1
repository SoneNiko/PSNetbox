...
PaginatedBookmarkList<PSCustomObject>
#>

function Initialize-PaginatedBookmarkList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedBookmarkList' | Write-Debug
...
Convert from JSON to PaginatedBookmarkList<PSCustomObject>
...
PaginatedBookmarkList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedBookmarkList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedBookmarkList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedBookmarkList
