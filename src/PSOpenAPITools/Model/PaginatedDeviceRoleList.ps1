...
PaginatedDeviceRoleList<PSCustomObject>
#>

function Initialize-PaginatedDeviceRoleList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedDeviceRoleList' | Write-Debug
...
Convert from JSON to PaginatedDeviceRoleList<PSCustomObject>
...
PaginatedDeviceRoleList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedDeviceRoleList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedDeviceRoleList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedDeviceRoleList
