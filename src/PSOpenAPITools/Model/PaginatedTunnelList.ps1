...
PaginatedTunnelList<PSCustomObject>
#>

function Initialize-PaginatedTunnelList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedTunnelList' | Write-Debug
...
Convert from JSON to PaginatedTunnelList<PSCustomObject>
...
PaginatedTunnelList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedTunnelList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedTunnelList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedTunnelList
