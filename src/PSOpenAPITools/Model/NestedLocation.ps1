...
NestedLocation<PSCustomObject>
#>

function Initialize-NestedLocation {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedLocation' | Write-Debug
...
Convert from JSON to NestedLocation<PSCustomObject>
...
NestedLocation<PSCustomObject>
#>
function ConvertFrom-JsonToNestedLocation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedLocation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedLocation
