...
PatchedWritableModuleTypeRequest<PSCustomObject>
#>

function Initialize-PatchedWritableModuleTypeRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableModuleTypeRequest' | Write-Debug
...
Convert from JSON to PatchedWritableModuleTypeRequest<PSCustomObject>
...
PatchedWritableModuleTypeRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableModuleTypeRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableModuleTypeRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableModuleTypeRequest
