...
NestedRackRole<PSCustomObject>
#>

function Initialize-NestedRackRole {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedRackRole' | Write-Debug
...
Convert from JSON to NestedRackRole<PSCustomObject>
...
NestedRackRole<PSCustomObject>
#>
function ConvertFrom-JsonToNestedRackRole {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedRackRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedRackRole
