...
PaginatedCircuitTerminationList<PSCustomObject>
#>

function Initialize-PaginatedCircuitTerminationList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedCircuitTerminationList' | Write-Debug
...
Convert from JSON to PaginatedCircuitTerminationList<PSCustomObject>
...
PaginatedCircuitTerminationList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedCircuitTerminationList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedCircuitTerminationList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedCircuitTerminationList
