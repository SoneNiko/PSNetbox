...
PatchedWritableModuleRequest<PSCustomObject>
#>

function Initialize-PatchedWritableModuleRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableModuleRequest' | Write-Debug
...
Convert from JSON to PatchedWritableModuleRequest<PSCustomObject>
...
PatchedWritableModuleRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableModuleRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableModuleRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableModuleRequest
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "module_bay"))) { #optional property not found
            $ModuleBay = $null
        } else {
