...
RouteTarget<PSCustomObject>
#>

function Initialize-RouteTarget {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RouteTarget' | Write-Debug
...
Convert from JSON to RouteTarget<PSCustomObject>
...
RouteTarget<PSCustomObject>
#>
function ConvertFrom-JsonToRouteTarget {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RouteTarget' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RouteTarget
        $AllProperties = ("id", "url", "display", "name", "tenant", "description", "comments", "tags", "custom_fields", "created", "last_updated")
