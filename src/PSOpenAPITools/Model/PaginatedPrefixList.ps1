...
PaginatedPrefixList<PSCustomObject>
#>

function Initialize-PaginatedPrefixList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedPrefixList' | Write-Debug
...
Convert from JSON to PaginatedPrefixList<PSCustomObject>
...
PaginatedPrefixList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedPrefixList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedPrefixList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedPrefixList
