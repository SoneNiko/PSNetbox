...
PaginatedCustomFieldList<PSCustomObject>
#>

function Initialize-PaginatedCustomFieldList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedCustomFieldList' | Write-Debug
...
Convert from JSON to PaginatedCustomFieldList<PSCustomObject>
...
PaginatedCustomFieldList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedCustomFieldList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedCustomFieldList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedCustomFieldList
