...
PaginatedModuleBayTemplateList<PSCustomObject>
#>

function Initialize-PaginatedModuleBayTemplateList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedModuleBayTemplateList' | Write-Debug
...
Convert from JSON to PaginatedModuleBayTemplateList<PSCustomObject>
...
PaginatedModuleBayTemplateList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedModuleBayTemplateList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedModuleBayTemplateList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedModuleBayTemplateList
