...
function Initialize-Provider {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Provider' | Write-Debug
...
function ConvertFrom-JsonToProvider {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Provider' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Provider
        $AllProperties = ("id", "url", "display", "name", "slug", "accounts", "description", "comments", "asns", "tags", "custom_fields", "created", "last_updated", "circuit_count")
