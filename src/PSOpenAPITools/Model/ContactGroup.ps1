...
ContactGroup<PSCustomObject>
#>

function Initialize-ContactGroup {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContactGroup' | Write-Debug
        ...
        if ($null -eq $ContactCount) {
            throw "invalid value for 'ContactCount', 'ContactCount' cannot be null."
        }
...
Convert from JSON to ContactGroup<PSCustomObject>
...
ContactGroup<PSCustomObject>
#>
function ConvertFrom-JsonToContactGroup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContactGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ContactGroup
        $AllProperties = ("id", "url", "display", "name", "slug", "parent", "description", "tags", "custom_fields", "created", "last_updated", "contact_count", "_depth")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "contact_count"))) {
            throw "Error! JSON cannot be serialized due to the required property 'contact_count' missing."
        } else {
            $ContactCount = $JsonParameters.PSobject.Properties["contact_count"].value
        }
