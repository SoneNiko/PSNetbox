...
PaginatedDeviceTypeList<PSCustomObject>
#>

function Initialize-PaginatedDeviceTypeList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedDeviceTypeList' | Write-Debug
...
Convert from JSON to PaginatedDeviceTypeList<PSCustomObject>
...
PaginatedDeviceTypeList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedDeviceTypeList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedDeviceTypeList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedDeviceTypeList
