...
PatchedWritableVirtualDeviceContextRequest<PSCustomObject>
#>

function Initialize-PatchedWritableVirtualDeviceContextRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableVirtualDeviceContextRequest' | Write-Debug
...
Convert from JSON to PatchedWritableVirtualDeviceContextRequest<PSCustomObject>
...
PatchedWritableVirtualDeviceContextRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableVirtualDeviceContextRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableVirtualDeviceContextRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableVirtualDeviceContextRequest
