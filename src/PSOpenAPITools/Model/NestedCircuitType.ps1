...
NestedCircuitType<PSCustomObject>
#>

function Initialize-NestedCircuitType {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedCircuitType' | Write-Debug
...
Convert from JSON to NestedCircuitType<PSCustomObject>
...
NestedCircuitType<PSCustomObject>
#>
function ConvertFrom-JsonToNestedCircuitType {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedCircuitType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedCircuitType
