...
PatchedWritableRearPortTemplateRequest<PSCustomObject>
#>

function Initialize-PatchedWritableRearPortTemplateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableRearPortTemplateRequest' | Write-Debug
...
Convert from JSON to PatchedWritableRearPortTemplateRequest<PSCustomObject>
...
PatchedWritableRearPortTemplateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableRearPortTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableRearPortTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableRearPortTemplateRequest
