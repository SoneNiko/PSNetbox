...
PatchedWritableInventoryItemRequest<PSCustomObject>
#>

function Initialize-PatchedWritableInventoryItemRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableInventoryItemRequest' | Write-Debug
...
Convert from JSON to PatchedWritableInventoryItemRequest<PSCustomObject>
...
PatchedWritableInventoryItemRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableInventoryItemRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableInventoryItemRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableInventoryItemRequest
