...
PaginatedRackRoleList<PSCustomObject>
#>

function Initialize-PaginatedRackRoleList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedRackRoleList' | Write-Debug
...
Convert from JSON to PaginatedRackRoleList<PSCustomObject>
...
PaginatedRackRoleList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedRackRoleList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedRackRoleList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedRackRoleList
