...
InterfacePoeType<PSCustomObject>
#>

function Initialize-InterfacePoeType {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InterfacePoeType' | Write-Debug
...
Convert from JSON to InterfacePoeType<PSCustomObject>
...
InterfacePoeType<PSCustomObject>
#>
function ConvertFrom-JsonToInterfacePoeType {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InterfacePoeType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InterfacePoeType
