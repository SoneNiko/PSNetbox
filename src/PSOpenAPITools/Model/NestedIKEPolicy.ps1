...
NestedIKEPolicy<PSCustomObject>
#>

function Initialize-NestedIKEPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedIKEPolicy' | Write-Debug
...
Convert from JSON to NestedIKEPolicy<PSCustomObject>
...
NestedIKEPolicy<PSCustomObject>
#>
function ConvertFrom-JsonToNestedIKEPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedIKEPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedIKEPolicy
