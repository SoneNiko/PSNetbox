...
WritableIPRangeRequest<PSCustomObject>
#>

function Initialize-WritableIPRangeRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableIPRangeRequest' | Write-Debug
...
Convert from JSON to WritableIPRangeRequest<PSCustomObject>
...
WritableIPRangeRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableIPRangeRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableIPRangeRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableIPRangeRequest
        ...
        If ([string]::IsNullOrEmpty($Json) -or $Json -eq "{}") { # empty json
            throw "Error! Empty JSON cannot be serialized due to the required property 'start_address' missing."
        }
