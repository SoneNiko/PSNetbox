...
PaginatedCableList<PSCustomObject>
#>

function Initialize-PaginatedCableList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedCableList' | Write-Debug
...
Convert from JSON to PaginatedCableList<PSCustomObject>
...
PaginatedCableList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedCableList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedCableList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedCableList
