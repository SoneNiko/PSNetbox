...
PaginatedPowerPanelList<PSCustomObject>
#>

function Initialize-PaginatedPowerPanelList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedPowerPanelList' | Write-Debug
...
Convert from JSON to PaginatedPowerPanelList<PSCustomObject>
...
PaginatedPowerPanelList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedPowerPanelList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedPowerPanelList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedPowerPanelList
