...
NestedContactRoleRequest<PSCustomObject>
#>

function Initialize-NestedContactRoleRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedContactRoleRequest' | Write-Debug
...
Convert from JSON to NestedContactRoleRequest<PSCustomObject>
...
NestedContactRoleRequest<PSCustomObject>
#>
function ConvertFrom-JsonToNestedContactRoleRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedContactRoleRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedContactRoleRequest
