...
PatchedWritableConsolePortRequest<PSCustomObject>
#>

function Initialize-PatchedWritableConsolePortRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableConsolePortRequest' | Write-Debug
...
Convert from JSON to PatchedWritableConsolePortRequest<PSCustomObject>
...
PatchedWritableConsolePortRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableConsolePortRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableConsolePortRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableConsolePortRequest
