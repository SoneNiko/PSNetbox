...
PaginatedRearPortTemplateList<PSCustomObject>
#>

function Initialize-PaginatedRearPortTemplateList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedRearPortTemplateList' | Write-Debug
...
Convert from JSON to PaginatedRearPortTemplateList<PSCustomObject>
...
PaginatedRearPortTemplateList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedRearPortTemplateList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedRearPortTemplateList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedRearPortTemplateList
