...
PaginatedConsolePortList<PSCustomObject>
#>

function Initialize-PaginatedConsolePortList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedConsolePortList' | Write-Debug
...
Convert from JSON to PaginatedConsolePortList<PSCustomObject>
...
PaginatedConsolePortList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedConsolePortList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedConsolePortList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedConsolePortList
