...
PatchedWritableConsoleServerPortRequest<PSCustomObject>
#>

function Initialize-PatchedWritableConsoleServerPortRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableConsoleServerPortRequest' | Write-Debug
...
Convert from JSON to PatchedWritableConsoleServerPortRequest<PSCustomObject>
...
PatchedWritableConsoleServerPortRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableConsoleServerPortRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableConsoleServerPortRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableConsoleServerPortRequest
