...
WirelessLAN<PSCustomObject>
#>

function Initialize-WirelessLAN {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WirelessLAN' | Write-Debug
...
Convert from JSON to WirelessLAN<PSCustomObject>
...
WirelessLAN<PSCustomObject>
#>
function ConvertFrom-JsonToWirelessLAN {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WirelessLAN' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WirelessLAN
        $AllProperties = ("id", "url", "display", "ssid", "description", "group", "status", "vlan", "tenant", "auth_type", "auth_cipher", "auth_psk", "comments", "tags", "custom_fields", "created", "last_updated")
