...
RackRole<PSCustomObject>
#>

function Initialize-RackRole {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RackRole' | Write-Debug
...
Convert from JSON to RackRole<PSCustomObject>
...
RackRole<PSCustomObject>
#>
function ConvertFrom-JsonToRackRole {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RackRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RackRole
        $AllProperties = ("id", "url", "display", "name", "slug", "color", "description", "tags", "custom_fields", "created", "last_updated", "rack_count")
