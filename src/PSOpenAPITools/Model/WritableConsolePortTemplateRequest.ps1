...
WritableConsolePortTemplateRequest<PSCustomObject>
#>

function Initialize-WritableConsolePortTemplateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableConsolePortTemplateRequest' | Write-Debug
...
Convert from JSON to WritableConsolePortTemplateRequest<PSCustomObject>
...
WritableConsolePortTemplateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableConsolePortTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableConsolePortTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableConsolePortTemplateRequest
