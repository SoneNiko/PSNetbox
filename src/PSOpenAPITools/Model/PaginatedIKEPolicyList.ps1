...
PaginatedIKEPolicyList<PSCustomObject>
#>

function Initialize-PaginatedIKEPolicyList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedIKEPolicyList' | Write-Debug
...
Convert from JSON to PaginatedIKEPolicyList<PSCustomObject>
...
PaginatedIKEPolicyList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedIKEPolicyList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedIKEPolicyList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedIKEPolicyList
