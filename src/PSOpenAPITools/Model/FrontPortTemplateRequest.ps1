...
FrontPortTemplateRequest<PSCustomObject>
#>

function Initialize-FrontPortTemplateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FrontPortTemplateRequest' | Write-Debug
...
Convert from JSON to FrontPortTemplateRequest<PSCustomObject>
...
FrontPortTemplateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToFrontPortTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FrontPortTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FrontPortTemplateRequest
