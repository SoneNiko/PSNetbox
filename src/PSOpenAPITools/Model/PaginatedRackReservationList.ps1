...
PaginatedRackReservationList<PSCustomObject>
#>

function Initialize-PaginatedRackReservationList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedRackReservationList' | Write-Debug
...
Convert from JSON to PaginatedRackReservationList<PSCustomObject>
...
PaginatedRackReservationList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedRackReservationList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedRackReservationList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedRackReservationList
