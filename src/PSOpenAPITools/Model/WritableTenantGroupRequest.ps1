...
WritableTenantGroupRequest<PSCustomObject>
#>

function Initialize-WritableTenantGroupRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableTenantGroupRequest' | Write-Debug
...
Convert from JSON to WritableTenantGroupRequest<PSCustomObject>
...
WritableTenantGroupRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableTenantGroupRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableTenantGroupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableTenantGroupRequest
