...
PaginatedInterfaceTemplateList<PSCustomObject>
#>

function Initialize-PaginatedInterfaceTemplateList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedInterfaceTemplateList' | Write-Debug
...
Convert from JSON to PaginatedInterfaceTemplateList<PSCustomObject>
...
PaginatedInterfaceTemplateList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedInterfaceTemplateList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedInterfaceTemplateList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedInterfaceTemplateList
