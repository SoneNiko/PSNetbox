...
function Initialize-TokenRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TokenRequest' | Write-Debug
...
Convert from JSON to TokenRequest<PSCustomObject>
...
TokenRequest<PSCustomObject>
#>
function ConvertFrom-JsonToTokenRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TokenRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TokenRequest
