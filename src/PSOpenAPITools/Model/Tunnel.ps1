...
function Initialize-Tunnel {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Tunnel' | Write-Debug
...
Convert from JSON to Tunnel<PSCustomObject>
...
Tunnel<PSCustomObject>
#>
function ConvertFrom-JsonToTunnel {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Tunnel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Tunnel
        $AllProperties = ("id", "url", "display", "name", "status", "group", "encapsulation", "ipsec_profile", "tenant", "tunnel_id", "description", "comments", "tags", "custom_fields", "created", "last_updated")
