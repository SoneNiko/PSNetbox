...
PatchedWritableDeviceWithConfigContextRequest<PSCustomObject>
#>

function Initialize-PatchedWritableDeviceWithConfigContextRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableDeviceWithConfigContextRequest' | Write-Debug
...
Convert from JSON to PatchedWritableDeviceWithConfigContextRequest<PSCustomObject>
...
PatchedWritableDeviceWithConfigContextRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableDeviceWithConfigContextRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableDeviceWithConfigContextRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableDeviceWithConfigContextRequest
