...
NestedRoleRequest<PSCustomObject>
#>

function Initialize-NestedRoleRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedRoleRequest' | Write-Debug
...
Convert from JSON to NestedRoleRequest<PSCustomObject>
...
NestedRoleRequest<PSCustomObject>
#>
function ConvertFrom-JsonToNestedRoleRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedRoleRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedRoleRequest
