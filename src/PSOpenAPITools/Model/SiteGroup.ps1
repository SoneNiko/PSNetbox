...
function Initialize-SiteGroup {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SiteGroup' | Write-Debug
...
Convert from JSON to SiteGroup<PSCustomObject>
...
SiteGroup<PSCustomObject>
#>
function ConvertFrom-JsonToSiteGroup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SiteGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SiteGroup
