...
NestedPowerPanel<PSCustomObject>
#>

function Initialize-NestedPowerPanel {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedPowerPanel' | Write-Debug
...
Convert from JSON to NestedPowerPanel<PSCustomObject>
...
NestedPowerPanel<PSCustomObject>
#>
function ConvertFrom-JsonToNestedPowerPanel {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedPowerPanel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedPowerPanel
