...
PaginatedSavedFilterList<PSCustomObject>
#>

function Initialize-PaginatedSavedFilterList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedSavedFilterList' | Write-Debug
...
Convert from JSON to PaginatedSavedFilterList<PSCustomObject>
...
PaginatedSavedFilterList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedSavedFilterList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedSavedFilterList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedSavedFilterList
