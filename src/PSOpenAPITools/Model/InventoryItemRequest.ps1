...
InventoryItemRequest<PSCustomObject>
#>

function Initialize-InventoryItemRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InventoryItemRequest' | Write-Debug
...
Convert from JSON to InventoryItemRequest<PSCustomObject>
...
InventoryItemRequest<PSCustomObject>
#>
function ConvertFrom-JsonToInventoryItemRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InventoryItemRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InventoryItemRequest
