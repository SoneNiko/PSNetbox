...
WritablePrefixRequest<PSCustomObject>
#>

function Initialize-WritablePrefixRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritablePrefixRequest' | Write-Debug
...
Convert from JSON to WritablePrefixRequest<PSCustomObject>
...
WritablePrefixRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritablePrefixRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritablePrefixRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritablePrefixRequest
