...
WritablePowerPortTemplateRequest<PSCustomObject>
#>

function Initialize-WritablePowerPortTemplateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritablePowerPortTemplateRequest' | Write-Debug
...
Convert from JSON to WritablePowerPortTemplateRequest<PSCustomObject>
...
WritablePowerPortTemplateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritablePowerPortTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritablePowerPortTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritablePowerPortTemplateRequest
