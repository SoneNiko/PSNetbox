...
PaginatedVirtualDeviceContextList<PSCustomObject>
#>

function Initialize-PaginatedVirtualDeviceContextList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedVirtualDeviceContextList' | Write-Debug
...
Convert from JSON to PaginatedVirtualDeviceContextList<PSCustomObject>
...
PaginatedVirtualDeviceContextList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedVirtualDeviceContextList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedVirtualDeviceContextList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedVirtualDeviceContextList
