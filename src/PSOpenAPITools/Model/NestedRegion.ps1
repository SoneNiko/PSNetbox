...
NestedRegion<PSCustomObject>
#>

function Initialize-NestedRegion {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedRegion' | Write-Debug
...
Convert from JSON to NestedRegion<PSCustomObject>
...
NestedRegion<PSCustomObject>
#>
function ConvertFrom-JsonToNestedRegion {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedRegion' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedRegion
