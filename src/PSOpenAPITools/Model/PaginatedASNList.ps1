...
PaginatedASNList<PSCustomObject>
#>

function Initialize-PaginatedASNList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedASNList' | Write-Debug
...
Convert from JSON to PaginatedASNList<PSCustomObject>
...
PaginatedASNList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedASNList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedASNList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedASNList
