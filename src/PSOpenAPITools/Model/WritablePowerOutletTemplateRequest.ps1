...
WritablePowerOutletTemplateRequest<PSCustomObject>
#>

function Initialize-WritablePowerOutletTemplateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritablePowerOutletTemplateRequest' | Write-Debug
...
Convert from JSON to WritablePowerOutletTemplateRequest<PSCustomObject>
...
WritablePowerOutletTemplateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritablePowerOutletTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritablePowerOutletTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritablePowerOutletTemplateRequest
