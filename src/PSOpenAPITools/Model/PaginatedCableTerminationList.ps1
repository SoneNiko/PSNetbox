...
PaginatedCableTerminationList<PSCustomObject>
#>

function Initialize-PaginatedCableTerminationList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedCableTerminationList' | Write-Debug
...
Convert from JSON to PaginatedCableTerminationList<PSCustomObject>
...
PaginatedCableTerminationList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedCableTerminationList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedCableTerminationList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedCableTerminationList
