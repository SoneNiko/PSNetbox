...
PaginatedConfigTemplateList<PSCustomObject>
#>

function Initialize-PaginatedConfigTemplateList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedConfigTemplateList' | Write-Debug
...
Convert from JSON to PaginatedConfigTemplateList<PSCustomObject>
...
PaginatedConfigTemplateList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedConfigTemplateList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedConfigTemplateList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedConfigTemplateList
