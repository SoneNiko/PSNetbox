...
PatchedWritablePowerPortRequest<PSCustomObject>
#>

function Initialize-PatchedWritablePowerPortRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritablePowerPortRequest' | Write-Debug
...
Convert from JSON to PatchedWritablePowerPortRequest<PSCustomObject>
...
PatchedWritablePowerPortRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritablePowerPortRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritablePowerPortRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritablePowerPortRequest
