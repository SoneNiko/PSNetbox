...
ModuleNestedModuleBay<PSCustomObject>
#>

function Initialize-ModuleNestedModuleBay {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModuleNestedModuleBay' | Write-Debug
...
Convert from JSON to ModuleNestedModuleBay<PSCustomObject>
...
ModuleNestedModuleBay<PSCustomObject>
#>
function ConvertFrom-JsonToModuleNestedModuleBay {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModuleNestedModuleBay' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ModuleNestedModuleBay
