...
VRFRequest<PSCustomObject>
#>

function Initialize-VRFRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => VRFRequest' | Write-Debug
...
Convert from JSON to VRFRequest<PSCustomObject>
...
VRFRequest<PSCustomObject>
#>
function ConvertFrom-JsonToVRFRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => VRFRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VRFRequest
