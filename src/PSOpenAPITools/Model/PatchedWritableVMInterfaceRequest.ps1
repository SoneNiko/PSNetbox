...
PatchedWritableVMInterfaceRequest<PSCustomObject>
#>

function Initialize-PatchedWritableVMInterfaceRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableVMInterfaceRequest' | Write-Debug
...
Convert from JSON to PatchedWritableVMInterfaceRequest<PSCustomObject>
...
PatchedWritableVMInterfaceRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableVMInterfaceRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableVMInterfaceRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableVMInterfaceRequest
