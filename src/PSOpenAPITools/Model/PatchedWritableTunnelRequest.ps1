...
PatchedWritableTunnelRequest<PSCustomObject>
#>

function Initialize-PatchedWritableTunnelRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableTunnelRequest' | Write-Debug
...
Convert from JSON to PatchedWritableTunnelRequest<PSCustomObject>
...
PatchedWritableTunnelRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableTunnelRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableTunnelRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableTunnelRequest
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "encapsulation"))) { #optional property not found
            $Encapsulation = $null
        } else {
