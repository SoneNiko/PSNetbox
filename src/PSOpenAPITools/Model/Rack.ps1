...
function Initialize-Rack {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Rack' | Write-Debug
        ...
        if ($null -eq $PowerfeedCount) {
            throw "invalid value for 'PowerfeedCount', 'PowerfeedCount' cannot be null."
        }
        ...
        $PSO = [PSCustomObject]@{
            ...
            "powerfeed_count" = ${PowerfeedCount}
        }
...
Convert from JSON to Rack<PSCustomObject>
...
Rack<PSCustomObject>
#>
function ConvertFrom-JsonToRack {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Rack' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Rack
        $AllProperties = ("id", "url", "display", "name", "facility_id", "site", "location", "tenant", "status", "role", "serial", "asset_tag", "type", "width", "u_height", "starting_unit", "weight", "max_weight", "weight_unit", "desc_units", "outer_width", "outer_depth", "outer_unit", "mounting_depth", "description", "comments", "tags", "custom_fields", "created", "last_updated", "device_count", "powerfeed_count")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "powerfeed_count"))) {
            throw "Error! JSON cannot be serialized due to the required property 'powerfeed_count' missing."
        } else {
            $PowerfeedCount = $JsonParameters.PSobject.Properties["powerfeed_count"].value
        }
