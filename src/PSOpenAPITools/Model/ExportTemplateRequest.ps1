...
ExportTemplateRequest<PSCustomObject>
#>

function Initialize-ExportTemplateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ExportTemplateRequest' | Write-Debug
...
Convert from JSON to ExportTemplateRequest<PSCustomObject>
...
ExportTemplateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToExportTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ExportTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ExportTemplateRequest
