...
PaginatedInventoryItemRoleList<PSCustomObject>
#>

function Initialize-PaginatedInventoryItemRoleList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedInventoryItemRoleList' | Write-Debug
...
Convert from JSON to PaginatedInventoryItemRoleList<PSCustomObject>
...
PaginatedInventoryItemRoleList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedInventoryItemRoleList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedInventoryItemRoleList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedInventoryItemRoleList
