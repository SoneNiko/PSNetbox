...
NestedVRF<PSCustomObject>
#>

function Initialize-NestedVRF {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedVRF' | Write-Debug
...
Convert from JSON to NestedVRF<PSCustomObject>
...
NestedVRF<PSCustomObject>
#>
function ConvertFrom-JsonToNestedVRF {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedVRF' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedVRF
        $AllProperties = ("id", "url", "display", "name", "rd")
