...
PaginatedLocationList<PSCustomObject>
#>

function Initialize-PaginatedLocationList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedLocationList' | Write-Debug
...
Convert from JSON to PaginatedLocationList<PSCustomObject>
...
PaginatedLocationList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedLocationList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedLocationList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedLocationList
