...
PaginatedIPSecProposalList<PSCustomObject>
#>

function Initialize-PaginatedIPSecProposalList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedIPSecProposalList' | Write-Debug
...
Convert from JSON to PaginatedIPSecProposalList<PSCustomObject>
...
PaginatedIPSecProposalList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedIPSecProposalList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedIPSecProposalList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedIPSecProposalList
