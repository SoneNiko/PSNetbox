...
NestedRIRRequest<PSCustomObject>
#>

function Initialize-NestedRIRRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedRIRRequest' | Write-Debug
...
Convert from JSON to NestedRIRRequest<PSCustomObject>
...
NestedRIRRequest<PSCustomObject>
#>
function ConvertFrom-JsonToNestedRIRRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedRIRRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedRIRRequest
