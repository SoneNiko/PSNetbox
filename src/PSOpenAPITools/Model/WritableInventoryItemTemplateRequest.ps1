...
WritableInventoryItemTemplateRequest<PSCustomObject>
#>

function Initialize-WritableInventoryItemTemplateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableInventoryItemTemplateRequest' | Write-Debug
...
Convert from JSON to WritableInventoryItemTemplateRequest<PSCustomObject>
...
WritableInventoryItemTemplateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableInventoryItemTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableInventoryItemTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableInventoryItemTemplateRequest
