...
PowerOutletTemplateRequest<PSCustomObject>
#>

function Initialize-PowerOutletTemplateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PowerOutletTemplateRequest' | Write-Debug
...
Convert from JSON to PowerOutletTemplateRequest<PSCustomObject>
...
PowerOutletTemplateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPowerOutletTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PowerOutletTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PowerOutletTemplateRequest
