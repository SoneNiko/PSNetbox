...
DeviceTypeRequest<PSCustomObject>
#>

function Initialize-DeviceTypeRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DeviceTypeRequest' | Write-Debug
...
Convert from JSON to DeviceTypeRequest<PSCustomObject>
...
DeviceTypeRequest<PSCustomObject>
#>
function ConvertFrom-JsonToDeviceTypeRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DeviceTypeRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeviceTypeRequest
