...
NestedRack<PSCustomObject>
#>

function Initialize-NestedRack {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedRack' | Write-Debug
...
Convert from JSON to NestedRack<PSCustomObject>
...
NestedRack<PSCustomObject>
#>
function ConvertFrom-JsonToNestedRack {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedRack' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedRack
