...
NestedInterface<PSCustomObject>
#>

function Initialize-NestedInterface {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedInterface' | Write-Debug
...
Convert from JSON to NestedInterface<PSCustomObject>
...
NestedInterface<PSCustomObject>
#>
function ConvertFrom-JsonToNestedInterface {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedInterface' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedInterface
