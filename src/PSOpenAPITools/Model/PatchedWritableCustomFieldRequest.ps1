...
PatchedWritableCustomFieldRequest<PSCustomObject>
#>

function Initialize-PatchedWritableCustomFieldRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWritableCustomFieldRequest' | Write-Debug
...
Convert from JSON to PatchedWritableCustomFieldRequest<PSCustomObject>
...
PatchedWritableCustomFieldRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWritableCustomFieldRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWritableCustomFieldRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWritableCustomFieldRequest
