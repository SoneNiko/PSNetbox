...
PaginatedTenantList<PSCustomObject>
#>

function Initialize-PaginatedTenantList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedTenantList' | Write-Debug
...
Convert from JSON to PaginatedTenantList<PSCustomObject>
...
PaginatedTenantList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedTenantList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedTenantList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedTenantList
