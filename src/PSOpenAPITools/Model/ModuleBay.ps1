...
ModuleBay<PSCustomObject>
#>

function Initialize-ModuleBay {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModuleBay' | Write-Debug
...
Convert from JSON to ModuleBay<PSCustomObject>
...
ModuleBay<PSCustomObject>
#>
function ConvertFrom-JsonToModuleBay {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModuleBay' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ModuleBay
        $AllProperties = ("id", "url", "display", "device", "name", "installed_module", "label", "position", "description", "tags", "custom_fields", "created", "last_updated")
