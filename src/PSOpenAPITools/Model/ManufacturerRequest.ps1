...
ManufacturerRequest<PSCustomObject>
#>

function Initialize-ManufacturerRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ManufacturerRequest' | Write-Debug
...
Convert from JSON to ManufacturerRequest<PSCustomObject>
...
ManufacturerRequest<PSCustomObject>
#>
function ConvertFrom-JsonToManufacturerRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ManufacturerRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ManufacturerRequest
