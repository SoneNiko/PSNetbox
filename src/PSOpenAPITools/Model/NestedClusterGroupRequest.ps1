...
NestedClusterGroupRequest<PSCustomObject>
#>

function Initialize-NestedClusterGroupRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedClusterGroupRequest' | Write-Debug
...
Convert from JSON to NestedClusterGroupRequest<PSCustomObject>
...
NestedClusterGroupRequest<PSCustomObject>
#>
function ConvertFrom-JsonToNestedClusterGroupRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedClusterGroupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedClusterGroupRequest
