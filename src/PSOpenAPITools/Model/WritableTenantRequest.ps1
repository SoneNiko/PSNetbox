...
WritableTenantRequest<PSCustomObject>
#>

function Initialize-WritableTenantRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableTenantRequest' | Write-Debug
...
Convert from JSON to WritableTenantRequest<PSCustomObject>
...
WritableTenantRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableTenantRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableTenantRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableTenantRequest
