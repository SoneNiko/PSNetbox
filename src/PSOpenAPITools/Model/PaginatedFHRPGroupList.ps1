...
PaginatedFHRPGroupList<PSCustomObject>
#>

function Initialize-PaginatedFHRPGroupList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedFHRPGroupList' | Write-Debug
...
Convert from JSON to PaginatedFHRPGroupList<PSCustomObject>
...
PaginatedFHRPGroupList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedFHRPGroupList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedFHRPGroupList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedFHRPGroupList
