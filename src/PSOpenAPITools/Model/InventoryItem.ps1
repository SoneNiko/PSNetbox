...
function Initialize-InventoryItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InventoryItem' | Write-Debug
...
Convert from JSON to InventoryItem<PSCustomObject>
...
InventoryItem<PSCustomObject>
#>
function ConvertFrom-JsonToInventoryItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InventoryItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InventoryItem
        $AllProperties = ("id", "url", "display", "device", "parent", "name", "label", "role", "manufacturer", "part_id", "serial", "asset_tag", "discovered", "description", "component_type", "component_id", "component", "tags", "custom_fields", "created", "last_updated", "_depth")
