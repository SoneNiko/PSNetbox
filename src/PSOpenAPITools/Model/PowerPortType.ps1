...
PowerPortType<PSCustomObject>
#>

function Initialize-PowerPortType {
    [CmdletBinding()]
    Param (
...
Convert from JSON to PowerPortType<PSCustomObject>
...
PowerPortType<PSCustomObject>
#>
function ConvertFrom-JsonToPowerPortType {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PowerPortType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PowerPortType
