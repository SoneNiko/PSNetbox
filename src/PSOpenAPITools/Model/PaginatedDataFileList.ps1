...
PaginatedDataFileList<PSCustomObject>
#>

function Initialize-PaginatedDataFileList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedDataFileList' | Write-Debug
...
Convert from JSON to PaginatedDataFileList<PSCustomObject>
...
PaginatedDataFileList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedDataFileList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedDataFileList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedDataFileList
