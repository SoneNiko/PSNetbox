...
PaginatedRackList<PSCustomObject>
#>

function Initialize-PaginatedRackList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedRackList' | Write-Debug
...
Convert from JSON to PaginatedRackList<PSCustomObject>
...
PaginatedRackList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedRackList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedRackList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedRackList
