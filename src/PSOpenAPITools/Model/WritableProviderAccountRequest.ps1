...
WritableProviderAccountRequest<PSCustomObject>
#>

function Initialize-WritableProviderAccountRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WritableProviderAccountRequest' | Write-Debug
...
Convert from JSON to WritableProviderAccountRequest<PSCustomObject>
...
WritableProviderAccountRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWritableProviderAccountRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WritableProviderAccountRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WritableProviderAccountRequest
