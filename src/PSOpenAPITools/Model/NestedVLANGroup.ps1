...
NestedVLANGroup<PSCustomObject>
#>

function Initialize-NestedVLANGroup {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NestedVLANGroup' | Write-Debug
...
Convert from JSON to NestedVLANGroup<PSCustomObject>
...
NestedVLANGroup<PSCustomObject>
#>
function ConvertFrom-JsonToNestedVLANGroup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NestedVLANGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NestedVLANGroup
