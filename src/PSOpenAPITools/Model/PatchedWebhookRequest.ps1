...
PatchedWebhookRequest<PSCustomObject>
#>

function Initialize-PatchedWebhookRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedWebhookRequest' | Write-Debug
...
Convert from JSON to PatchedWebhookRequest<PSCustomObject>
...
PatchedWebhookRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedWebhookRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedWebhookRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedWebhookRequest
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "payload_url"))) { #optional property not found
            $PayloadUrl = $null
        } else {
