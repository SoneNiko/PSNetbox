...
PaginatedVMInterfaceList<PSCustomObject>
#>

function Initialize-PaginatedVMInterfaceList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedVMInterfaceList' | Write-Debug
...
Convert from JSON to PaginatedVMInterfaceList<PSCustomObject>
...
PaginatedVMInterfaceList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedVMInterfaceList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedVMInterfaceList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedVMInterfaceList
