...
IPSecProposalRequest<PSCustomObject>
#>

function Initialize-IPSecProposalRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IPSecProposalRequest' | Write-Debug
...
Convert from JSON to IPSecProposalRequest<PSCustomObject>
...
IPSecProposalRequest<PSCustomObject>
#>
function ConvertFrom-JsonToIPSecProposalRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IPSecProposalRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IPSecProposalRequest
