...
PaginatedConsoleServerPortList<PSCustomObject>
#>

function Initialize-PaginatedConsoleServerPortList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedConsoleServerPortList' | Write-Debug
...
Convert from JSON to PaginatedConsoleServerPortList<PSCustomObject>
...
PaginatedConsoleServerPortList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedConsoleServerPortList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedConsoleServerPortList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedConsoleServerPortList
