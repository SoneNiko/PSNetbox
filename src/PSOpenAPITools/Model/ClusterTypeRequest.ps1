...
ClusterTypeRequest<PSCustomObject>
#>

function Initialize-ClusterTypeRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClusterTypeRequest' | Write-Debug
...
Convert from JSON to ClusterTypeRequest<PSCustomObject>
...
ClusterTypeRequest<PSCustomObject>
#>
function ConvertFrom-JsonToClusterTypeRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClusterTypeRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClusterTypeRequest
