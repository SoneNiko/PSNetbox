...
InventoryItemRoleRequest<PSCustomObject>
#>

function Initialize-InventoryItemRoleRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InventoryItemRoleRequest' | Write-Debug
...
Convert from JSON to InventoryItemRoleRequest<PSCustomObject>
...
InventoryItemRoleRequest<PSCustomObject>
#>
function ConvertFrom-JsonToInventoryItemRoleRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InventoryItemRoleRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InventoryItemRoleRequest
