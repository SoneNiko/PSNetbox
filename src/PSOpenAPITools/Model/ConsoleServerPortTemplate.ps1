...
ConsoleServerPortTemplate<PSCustomObject>
#>

function Initialize-ConsoleServerPortTemplate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ConsoleServerPortTemplate' | Write-Debug
...
Convert from JSON to ConsoleServerPortTemplate<PSCustomObject>
...
ConsoleServerPortTemplate<PSCustomObject>
#>
function ConvertFrom-JsonToConsoleServerPortTemplate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ConsoleServerPortTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ConsoleServerPortTemplate
        $AllProperties = ("id", "url", "display", "device_type", "module_type", "name", "label", "type", "description", "created", "last_updated")
