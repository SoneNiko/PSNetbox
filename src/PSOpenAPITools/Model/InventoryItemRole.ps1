...
InventoryItemRole<PSCustomObject>
#>

function Initialize-InventoryItemRole {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InventoryItemRole' | Write-Debug
...
Convert from JSON to InventoryItemRole<PSCustomObject>
...
InventoryItemRole<PSCustomObject>
#>
function ConvertFrom-JsonToInventoryItemRole {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InventoryItemRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InventoryItemRole
        $AllProperties = ("id", "url", "display", "name", "slug", "color", "description", "tags", "custom_fields", "created", "last_updated", "inventoryitem_count")
