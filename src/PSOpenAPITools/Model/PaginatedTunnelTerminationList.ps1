...
PaginatedTunnelTerminationList<PSCustomObject>
#>

function Initialize-PaginatedTunnelTerminationList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedTunnelTerminationList' | Write-Debug
...
Convert from JSON to PaginatedTunnelTerminationList<PSCustomObject>
...
PaginatedTunnelTerminationList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedTunnelTerminationList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedTunnelTerminationList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedTunnelTerminationList
