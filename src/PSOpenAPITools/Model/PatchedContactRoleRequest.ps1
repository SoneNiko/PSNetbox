...
PatchedContactRoleRequest<PSCustomObject>
#>

function Initialize-PatchedContactRoleRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchedContactRoleRequest' | Write-Debug
...
Convert from JSON to PatchedContactRoleRequest<PSCustomObject>
...
PatchedContactRoleRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchedContactRoleRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchedContactRoleRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchedContactRoleRequest
