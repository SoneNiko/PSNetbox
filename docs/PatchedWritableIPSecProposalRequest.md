...
```powershell
$PatchedWritableIPSecProposalRequest = Initialize-PSOpenAPIToolsPatchedWritableIPSecProposalRequest  -Name null `
 -Description null `
...
```powershell
$PatchedWritableIPSecProposalRequest | ConvertTo-JSON
```
