...
```powershell
$WritablePowerOutletTemplateRequest = Initialize-PSOpenAPIToolsWritablePowerOutletTemplateRequest  -DeviceType null `
 -ModuleType null `
 -Name null `
 -Label null `
 -Type null `
...
```powershell
$WritablePowerOutletTemplateRequest | ConvertTo-JSON
```
