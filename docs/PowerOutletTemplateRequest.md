...
**PowerPort** | [**NestedPowerPortTemplateRequest**](NestedPowerPortTemplateRequest.md) |  | [optional] 
...
```powershell
$PowerOutletTemplateRequest = Initialize-PSOpenAPIToolsPowerOutletTemplateRequest  -DeviceType null `
 -ModuleType null `
 -Name null `
 -Label null `
 -Type null `
...
```powershell
$PowerOutletTemplateRequest | ConvertTo-JSON
```
