...
```powershell
$PatchedWritablePowerPortTemplateRequest = Initialize-PSOpenAPIToolsPatchedWritablePowerPortTemplateRequest  -DeviceType null `
 -ModuleType null `
 -Name null `
 -Label null `
 -Type null `
...
```powershell
$PatchedWritablePowerPortTemplateRequest | ConvertTo-JSON
```
