...
```powershell
$WritablePowerPortTemplateRequest = Initialize-PSOpenAPIToolsWritablePowerPortTemplateRequest  -DeviceType null `
 -ModuleType null `
 -Name null `
 -Label null `
 -Type null `
...
```powershell
$WritablePowerPortTemplateRequest | ConvertTo-JSON
```
