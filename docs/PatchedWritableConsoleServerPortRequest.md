...
```powershell
$PatchedWritableConsoleServerPortRequest = Initialize-PSOpenAPIToolsPatchedWritableConsoleServerPortRequest  -Device null `
 -Module null `
 -Name null `
 -Label null `
 -Type null `
...
```powershell
$PatchedWritableConsoleServerPortRequest | ConvertTo-JSON
```
