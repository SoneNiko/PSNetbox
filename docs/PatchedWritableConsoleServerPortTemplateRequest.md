...
```powershell
$PatchedWritableConsoleServerPortTemplateRequest = Initialize-PSOpenAPIToolsPatchedWritableConsoleServerPortTemplateRequest  -DeviceType null `
 -ModuleType null `
 -Name null `
 -Label null `
 -Type null `
...
```powershell
$PatchedWritableConsoleServerPortTemplateRequest | ConvertTo-JSON
```
