...
```powershell
$WritableInterfaceTemplateRequest = Initialize-PSOpenAPIToolsWritableInterfaceTemplateRequest  -DeviceType null `
 -ModuleType null `
 -Name null `
 -Label null `
 -Type null `
...
```powershell
$WritableInterfaceTemplateRequest | ConvertTo-JSON
```
