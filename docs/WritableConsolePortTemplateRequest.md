...
```powershell
$WritableConsolePortTemplateRequest = Initialize-PSOpenAPIToolsWritableConsolePortTemplateRequest  -DeviceType null `
 -ModuleType null `
 -Name null `
 -Label null `
 -Type null `
...
```powershell
$WritableConsolePortTemplateRequest | ConvertTo-JSON
```
