...
```powershell
$PatchedWritableIPSecPolicyRequest = Initialize-PSOpenAPIToolsPatchedWritableIPSecPolicyRequest  -Name null `
 -Description null `
 -Proposals null `
 -PfsGroup null `
 -Comments null `
...
```powershell
$PatchedWritableIPSecPolicyRequest | ConvertTo-JSON
```
