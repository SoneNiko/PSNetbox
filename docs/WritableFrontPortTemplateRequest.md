...
```powershell
$WritableFrontPortTemplateRequest = Initialize-PSOpenAPIToolsWritableFrontPortTemplateRequest  -DeviceType null `
 -ModuleType null `
 -Name null `
 -Label null `
 -Type null `
...
```powershell
$WritableFrontPortTemplateRequest | ConvertTo-JSON
```
