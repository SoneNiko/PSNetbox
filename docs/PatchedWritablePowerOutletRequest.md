...
```powershell
$PatchedWritablePowerOutletRequest = Initialize-PSOpenAPIToolsPatchedWritablePowerOutletRequest  -Device null `
 -Module null `
 -Name null `
 -Label null `
 -Type null `
...
```powershell
$PatchedWritablePowerOutletRequest | ConvertTo-JSON
```
