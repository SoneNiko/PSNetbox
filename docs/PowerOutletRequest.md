...
**PowerPort** | [**NestedPowerPortRequest**](NestedPowerPortRequest.md) |  | [optional] 
**FeedLeg** | **String** | * &#x60;A&#x60; - A * &#x60;B&#x60; - B * &#x60;C&#x60; - C | [optional] 
...
```powershell
$PowerOutletRequest = Initialize-PSOpenAPIToolsPowerOutletRequest  -Device null `
 -Module null `
 -Name null `
 -Label null `
 -Type null `
...
```powershell
$PowerOutletRequest | ConvertTo-JSON
```
