...
```powershell
$WritableRearPortTemplateRequest = Initialize-PSOpenAPIToolsWritableRearPortTemplateRequest  -DeviceType null `
 -ModuleType null `
 -Name null `
 -Label null `
 -Type null `
...
```powershell
$WritableRearPortTemplateRequest | ConvertTo-JSON
```
