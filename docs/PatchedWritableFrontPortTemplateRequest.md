...
```powershell
$PatchedWritableFrontPortTemplateRequest = Initialize-PSOpenAPIToolsPatchedWritableFrontPortTemplateRequest  -DeviceType null `
 -ModuleType null `
 -Name null `
 -Label null `
 -Type null `
...
```powershell
$PatchedWritableFrontPortTemplateRequest | ConvertTo-JSON
```
