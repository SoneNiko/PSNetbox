...
```powershell
$WritableConsoleServerPortTemplateRequest = Initialize-PSOpenAPIToolsWritableConsoleServerPortTemplateRequest  -DeviceType null `
 -ModuleType null `
 -Name null `
 -Label null `
 -Type null `
...
```powershell
$WritableConsoleServerPortTemplateRequest | ConvertTo-JSON
```
